...
| Schedule scoped learning | `forecast schedule add --domain macro --topic inflation --cadence 1d --next-run-at <time> --stale-days 3 --confidence-below 0.5 --auto-score --auto-postmortem` or `forecast schedule add --horizon 30 --cadence 1d --next-run-at <time>` |
