#!/usr/bin/env python3
"""Build the Superforecasting Agent Model Catalog.
...
Superforecasting Agent CLI fetches at runtime. Publishing the catalog through
the docs site lets maintainers update model lists without shipping a release.
...
# Ensure HERMES_HOME is bridged for inherited imports that touch it at module level.
default_home = os.environ.get("SUPERFORECASTING_AGENT_HOME") or os.environ.get("FORECAST_HOME")
os.environ.setdefault("HERMES_HOME", default_home or os.path.join(os.path.expanduser("~"), ".superforecasting-agent"))

from superforecasting_agent.runtime.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "superforecasting-agent repo",
            "docs": "https://teddyjfpender.github.io/superforecasting-agent/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
