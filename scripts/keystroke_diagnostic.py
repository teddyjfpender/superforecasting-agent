...
Useful when adding a keybinding to Superforecasting Agent (or any
prompt_toolkit app) and you need to know what the terminal actually delivers
— particularly on Windows, where terminals can collapse, intercept, or
silently remap key combinations.
...
Then in Superforecasting Agent, bind the newline behaviour to that key:
    @kb.add('c-j')
