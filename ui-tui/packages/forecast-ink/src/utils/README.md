# Terminal renderer — utils

ANSI-safe text and process/environment helpers used by the renderer.
...
| [earlyInput.ts](earlyInput.ts)                     | earlyInput.            |
| [env.ts](env.ts)                                   | env.                   |
| [envAlias.ts](envAlias.ts)                         | envAlias.              |
| [envUtils.ts](envUtils.ts)                         | envUtils.              |
| [execFileNoThrow.test.ts](execFileNoThrow.test.ts) | execFileNoThrow tests. |
| [execFileNoThrow.ts](execFileNoThrow.ts)           | execFileNoThrow.       |
| [fullscreen.test.ts](fullscreen.test.ts)           | fullscreen tests.      |
