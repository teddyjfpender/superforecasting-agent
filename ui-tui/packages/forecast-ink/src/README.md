...
Public exports for the terminal rendering package.
...
| File                                 | Responsibility |
| ------------------------------------ | -------------- |
| [entry-exports.ts](entry-exports.ts) | entry-exports. |

## Subdirectories

- [bootstrap/](bootstrap/README.md) — Terminal renderer — bootstrap.
- [hooks/](hooks/README.md) — Terminal renderer — hooks.
- [ink/](ink/README.md) — Terminal renderer — ink.
- [native-ts/](native-ts/README.md) — native-ts.
- [utils/](utils/README.md) — Terminal renderer — utils.
