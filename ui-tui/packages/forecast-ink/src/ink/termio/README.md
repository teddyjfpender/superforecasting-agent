# Terminal renderer — ink / termio

Parsing and tokenization of terminal escape sequences and control commands.
...
| File                       | Responsibility |
| -------------------------- | -------------- |
| [ansi.ts](ansi.ts)         | ansi.          |
| [csi.ts](csi.ts)           | csi.           |
| [dec.test.ts](dec.test.ts) | dec tests.     |
| [dec.ts](dec.ts)           | dec.           |
| [esc.ts](esc.ts)           | esc.           |
| [osc.test.ts](osc.test.ts) | osc tests.     |
| [osc.ts](osc.ts)           | osc.           |
