# Forecast view helpers

Provides search and formatting for forecast views.

## Ownership and boundaries

Keep transforms deterministic and do not change numeric probabilities while formatting them.
