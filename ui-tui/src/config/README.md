...
Defines timing, limits and environment interpretation for the client.

## Ownership and boundaries

Keep presentation defaults here and durable user configuration in the backend owner.
...
| ---------------------- | -------------- |
| [env.ts](env.ts)       | env.           |
| [limits.ts](limits.ts) | limits.        |
| [timing.ts](timing.ts) | timing.        |
