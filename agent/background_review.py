...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • Bundled skills (shipped with Superforecasting Agent, e.g. 'hermes-agent' compatibility skill).\n"
    "  • Hub-installed skills (installed via 'superforecasting-agent skills install').\n"
    "  • Pinned skills (marked via 'superforecasting-agent curator pin').\n"
