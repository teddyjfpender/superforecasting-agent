...
Plugins built on Superforecasting Agent often need to make their own LLM calls
...
:class:`~superforecasting_agent.runtime.plugins.PluginContext`:
...
class PluginLlm:
    ...
    Instances are constructed by :class:`superforecasting_agent.runtime.plugins.PluginContext`
