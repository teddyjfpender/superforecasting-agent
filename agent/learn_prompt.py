...
gateway ``/learn``, the TUI/dashboard chat) calls :func:`build_learn_prompt`
and feeds the result to the agent as a normal turn.
"""

from __future__ import annotations

# The house-style rules, distilled from the skill-authoring standards and the
# new-skill salvage reference. Embedded in the prompt so the agent authors
# skills the way a maintainer would by hand.
