...
Cache location: ~/.superforecasting-agent/sticker_cache.json for new installs;
legacy ~/.hermes/sticker_cache.json remains readable during migration.
"""
...
CACHE_PATH = get_agent_home() / "sticker_cache.json"
