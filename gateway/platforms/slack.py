...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_agent_home() / "slack_tokens.json"
        ...
        try:
            ...
            from superforecasting_agent.runtime.commands import slack_native_slashes
            import re as _re
    ...
    def _dm_top_level_threads_as_sessions(self) -> bool:
        ...
        own forecast research session — matching the per-thread behavior channels already
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        if slash_name in {"hermes", ""}:
            ...
            from superforecasting_agent.runtime.commands import slack_subcommand_map
