...
def managed_nous_tools_enabled() -> bool:
    ...
    try:
        ...
        from superforecasting_agent.runtime.models import check_nous_free_tier
...
def fal_key_is_configured() -> bool:
    ...
    Consults both ``os.environ`` and the active agent-home ``.env`` (via
    ``superforecasting_agent.runtime.config.get_env_value`` when available) so tool-side
