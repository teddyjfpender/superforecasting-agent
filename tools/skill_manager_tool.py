...
active agent-home skills/ directory. Existing skills (bundled, hub-installed,
or user-created) can be modified or deleted wherever they live.
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local active-home skills dir first, then any
