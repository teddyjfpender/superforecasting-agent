...
from forecasting.sources.evidence import (
    source_evidence_payload as _source_adapter_evidence_payload,
    news_triage_metadata as _tool_news_triage_metadata,
    _adapter_item_dict,
...
from forecasting.sources.dispatch import (
    load_source_items as _load_source_adapter_items,
...
FORECAST_LEDGER_SCHEMA = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "censoring": {"type": "object", "description": "Predeclared right-censoring event; scores only threshold probability, not the hidden exact value.",
                "properties": {"threshold": {"type": "number"}, "inclusive": {"type": "boolean"}},
                "required": ["threshold", "inclusive"], "additionalProperties": False},
            "units": {"type": "string"},
