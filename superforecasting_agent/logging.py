...
from superforecasting_agent.constants import get_config_path, get_agent_home
...
COMPONENT_PREFIXES = {
    ...
    "agent": ("agent", "run_agent", "superforecasting_agent.tooling.runtime", "superforecasting_agent.trajectories.batch"),
    "tools": ("tools",),
    "cli": ("superforecasting_agent.runtime", "cli"),
    "cron": ("cron",),
}
...
def setup_logging(
    ...
    *force* is ``True``.
    ...
    hermes_home
        ...
        ``get_agent_home()`` for profile-aware path resolution.
    log_level
...
class _ManagedRotatingFileHandler(RotatingFileHandler):
    ...
    def __init__(self, *args, **kwargs):
        from superforecasting_agent.runtime.config import is_managed
