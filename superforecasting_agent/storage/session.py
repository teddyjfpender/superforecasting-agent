...
from superforecasting_agent.storage.schema import (
    FTS_TRIGRAM_SQL as FTS_TRIGRAM_SQL,
)
from superforecasting_agent.storage.schema import (
    SCHEMA_SQL as SCHEMA_SQL,
)
from superforecasting_agent.storage.schema import (
    SCHEMA_VERSION as SCHEMA_VERSION,
)
from superforecasting_agent.storage.sqlite import (
    _WAL_INCOMPAT_MARKERS as _WAL_INCOMPAT_MARKERS,
)
from superforecasting_agent.storage.sqlite import (
...
from superforecasting_agent.storage.sqlite import (
    _wal_fallback_warned_paths as _wal_fallback_warned_paths,
)
from superforecasting_agent.storage.sqlite import (
    format_session_db_unavailable as format_session_db_unavailable,
)
from superforecasting_agent.storage.sqlite import (
    get_last_init_error as get_last_init_error,
)
...
class SessionDB:
    ...
    finalize_orphaned_compression_sessions = (
        _retention.finalize_orphaned_compression_sessions
    )
    ...
    _is_duplicate_replayed_user_message = staticmethod(
        _replay._is_duplicate_replayed_user_message
    )
    # =========================================================================
    # Search
    # =========================================================================
    ...
    list_telegram_topic_bindings_for_chat = (
        _telegram.list_telegram_topic_bindings_for_chat
    )
    get_telegram_topic_binding_by_session = (
        _telegram.get_telegram_topic_binding_by_session
    )
    ...
    list_unlinked_telegram_sessions_for_user = (
        _telegram.list_unlinked_telegram_sessions_for_user
    )
    # ── Space reclamation ──
