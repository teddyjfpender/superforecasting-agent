...
_PROFILE_DIRS = [
    ...
    # See superforecasting_agent.constants.get_subprocess_home() and issue #4426.
    "home",
]
...
def _cleanup_gateway_service(name: str, profile_dir: Path) -> None:
    ...
    try:
        ...
        from superforecasting_agent.runtime.gateway import get_service_name, get_launchd_plist_path
...
def import_profile(archive_path: str, name: Optional[str] = None) -> Path:
    ...
    with tempfile.TemporaryDirectory(prefix="forecast_profile_import_") as tmpdir:
