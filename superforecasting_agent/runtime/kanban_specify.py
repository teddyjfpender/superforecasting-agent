...
Used by ``superforecasting-agent kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``superforecasting_agent/runtime/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Superforecasting Agent board.
...
def _profile_author() -> str:
    """Mirror of ``superforecasting_agent.runtime.kanban._profile_author``. Kept local to
