...
CONFIGURABLE_TOOLSETS = [
    ("forecasting",     "📈 Forecast Ledger",          "forecast_ledger lifecycle and learning writes"),
...
_DEFAULT_OFF_TOOLSETS = {"moa", "homeassistant", "discord", "discord_admin", "video", "video_gen", "x_search"}
...
def _get_effective_configurable_toolsets():
    ...
    try:
        from superforecasting_agent.runtime.plugins import discover_plugins, get_plugin_toolsets
...
def _get_platform_tools(
    ...
    *,
    ...
    from superforecasting_agent.tooling.toolsets import resolve_toolset, TOOLSETS
...
def _save_platform_tools(config: dict, platform: str, enabled_toolset_keys: Set[str]):
    ...
    bundled_composite_keys = {
        key for key, value in TOOLSETS.items()
