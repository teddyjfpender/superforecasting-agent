...
def _inherited_flag(parser, *args, **kwargs):
    """Register a flag that ``superforecasting_agent.runtime.relaunch`` should carry over when
...
def build_top_level_parser():
    ...
    _inherited_flag(
        ...
        help=(
            ...
            "without a TTY prompt.  Equivalent to SUPERFORECASTING_AGENT_ACCEPT_HOOKS=1 or "
    ...
    _inherited_flag(
        ...
        action="store_true",
        default=False,
        help="Ignore ~/.superforecasting-agent/config.yaml and fall back to built-in defaults (credentials in .env are still loaded)",
    )
    _inherited_flag(
        parser,
        "--ignore-rules",
    ...
    _inherited_flag(
        ...
        help=(
            "Auto-approve any unseen shell hooks declared in config.yaml "
            "without a TTY prompt (see also SUPERFORECASTING_AGENT_ACCEPT_HOOKS env var and "
    ...
    chat_parser.add_argument(
        ...
        default=None,
        metavar="N",
        help="Maximum tool-calling iterations per forecast-support turn (default: 200, or agent.max_turns in config; a breach checkpoints and continues, not a hard stop)",
    )
    _inherited_flag(
        chat_parser,
        "--yolo",
    ...
    _inherited_flag(
        ...
        action="store_true",
        default=argparse.SUPPRESS,
        help="Ignore ~/.superforecasting-agent/config.yaml and fall back to built-in defaults (credentials in .env are still loaded). Useful for isolated CI runs, reproduction, and third-party integrations.",
    )
    _inherited_flag(
        chat_parser,
        "--ignore-rules",
