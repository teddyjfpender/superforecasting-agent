"""
Cron subcommand for the Superforecasting Agent CLI.
...
def cron_list(show_all: bool = False):
    ...
    if not jobs:
        ...
        print(color("Create one with 'superforecasting-agent cron create ...' or the /cron command in chat.", Colors.DIM))
        return
    ...
    if not find_gateway_pids():
        ...
        print(color("     Start it with: superforecasting-agent gateway install", Colors.DIM))
        print(color("                    sudo superforecasting-agent gateway install --system  # Linux servers", Colors.DIM))
        print()
...
def cron_status():
    ...
    if pids:
        ...
        print("    superforecasting-agent gateway install    # Install as a user service")
        print("    sudo superforecasting-agent gateway install --system  # Linux servers: boot-time system service")
        print("    superforecasting-agent gateway            # Or run in foreground")
...
def cron_command(args):
    ...
    print("Usage: superforecasting-agent cron [list|create|edit|pause|resume|run|remove|status|tick]")
    sys.exit(1)
