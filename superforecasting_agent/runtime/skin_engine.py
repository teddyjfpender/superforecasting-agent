...
.. code-block:: python
    ...
    from superforecasting_agent.runtime.skin_engine import get_active_skin, list_skins, set_active_skin
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    ...
    "terminal-amber": {
        "name": "terminal-amber",
        "description": "Terminal Amber — black canvas, amber headings, high-contrast market data",
        "colors": {
            "ui_background": "#000000",
            "banner_border": "#A3A3A3",
            "banner_title": "#FFB347",
            ...
            "prompt": "#FFB347",
            "input_rule": "#A3A3A3",
            "response_border": "#FFB347",
            "status_bar_bg": "#0B0B0B",
            "status_bar_text": "#F5F5F5",
            "status_bar_good": "#76E69D",
            "status_bar_warn": "#FFE066",
            "status_bar_bad": "#FF9696",
            "status_bar_critical": "#FF9696",
            "session_label": "#B8B8B8",
            "session_border": "#A3A3A3",
            "completion_menu_bg": "#0B0B0B",
            "completion_menu_current_bg": "#172433",
            "completion_menu_meta_bg": "#0B0B0B",
            "completion_menu_meta_current_bg": "#172433",
            "selection_bg": "#172433",
            "shell_dollar": "#66D9EF",
        },
        "spinner": {},
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "forecast": {
        ...
        "colors": {
            ...
            "status_bar_text": "#D4D7DC",
            "status_bar_strong": "#8FE3CF",
            "status_bar_dim": "#8A9099",
            "status_bar_good": "#63D0A6",
