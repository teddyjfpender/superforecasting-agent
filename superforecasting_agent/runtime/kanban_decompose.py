...
Invoked by ``superforecasting-agent kanban decompose [task_id | --all]`` and the
...
* Mirrors the shape of ``superforecasting_agent/runtime/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Superforecasting Agent board.
...
def _profile_author() -> str:
    """Mirror of ``superforecasting_agent.runtime.kanban._profile_author``."""
    return (
