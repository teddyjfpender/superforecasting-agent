...
The Superforecasting Agent fork can host a JSON manifest of curated models
for providers we want to update without shipping a release (currently
...
DEFAULT_CATALOG_URL = (
    "https://raw.githubusercontent.com/teddyjfpender/superforecasting-agent/superforecasting-agent-snapshot/website/static/api/model-catalog.json"
)
...
def _cache_path() -> Path:
    ...
    return get_agent_home() / "cache" / "model_catalog.json"
