"""Shared curses-based UI components for Superforecasting Agent CLI.

Used by `superforecasting-agent tools` and `superforecasting-agent skills` for interactive checklists.
