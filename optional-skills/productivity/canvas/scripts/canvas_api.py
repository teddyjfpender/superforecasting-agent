#!/usr/bin/env python3
"""Canvas LMS API CLI for Superforecasting Agent.
...
def _check_config():
    ...
    if missing:
        print(
            ...
            "Set them in ~/.superforecasting-agent/.env or export them in your shell.\n"
...
def main():
    parser = argparse.ArgumentParser(
        description="Canvas LMS API CLI for Superforecasting Agent"
    )
