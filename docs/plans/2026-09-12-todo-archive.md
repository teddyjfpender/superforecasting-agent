# Archived chronological TODO — September 12, 2026

This is a historical checklist. Use [the active TODO](../../TODO.md) for current priorities.

# Remaining work

This is the follow-up list from the September 2026 repository cleanup. Completed
work and verification are recorded in the [cleanup review](2026-09-10-cleanup-review.md)
...
[product boundaries plan](2026-09-11-product-boundaries.md). This includes
...
includes remaining agent construction/notification wiring and legacy command
orchestration, lower-level resource cleanup, and cross-version
...
See [investigation, changes and evidence limits](2026-09-11-runtime-ownership.md).
...
See [verification and reproduction](2026-09-10-forecast-reliability.md).
...
See [current evidence and limits](2026-09-11-forecast-quality.md).
...
See [implementation, live operations and limits](2026-09-11-learning-settlement-runtime.md).
...
See [implementation and verification](2026-09-11-engineering-integrity.md).
...
See [implementation, reproduction and limits](2026-09-11-source-portability-runtime.md).
...
See [runtime changes and verification](2026-09-10-lifecycle-learning.md).
...
See [live recovery, ledger hardening and measurement methodology](2026-09-10-live-lifecycle-learning.md).

## Controlled learning and durable settlement

See [commands, invariants and limits](2026-09-10-controlled-learning-lifecycle.md).
...
See [trial follow-up evidence](2026-09-11-trial-followup.md) for quota pauses,
