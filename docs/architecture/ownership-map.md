...
| `superforecasting_agent/hosting/browser_sessions.py` | browser lifecycle admission | Per-task primary/sidecar creation and cleanup serialization; unrelated task groups remain independent | No provider, tools, runtime or presentation imports; hosting contracts apply |
