...
| `forecasting/panel_selection.py` | connected-panel policy | Deterministic selection from an ordered provider/default-model snapshot; quorum adapter owns discovery | No runtime, agent, tools, quorum orchestration or presentation imports; strict lint/format/types |
