...
TIPS = [
    ...
    "superforecasting-agent sessions browse opens an interactive session picker with search.",
    "superforecasting-agent sessions stats shows session counts by platform and database size.",
    "superforecasting-agent sessions prune --older-than 30 cleans up old sessions.",
