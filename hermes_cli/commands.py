...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("evidence-for", "Add evidence to a forecast found by row or words", "Forecast Desk",
               aliases=("note", "note-for"), args_hint="<row|words> -- <note>", cli_only=True),
    CommandDef("update-for", "Update a forecast found by row or words", "Forecast Desk",
               aliases=("updateq", "revise"), args_hint="<row|words> -- <args>", cli_only=True),
