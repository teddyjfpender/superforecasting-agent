...
from hermes_constants import get_hermes_home, display_hermes_home  # noqa: F811,E402
...
DEFAULT_CONFIG = {
    ...
    # Opt in via ``superforecasting-agent chat --checkpoints`` or set enabled=True here.
    "checkpoints": {
        "enabled": False,
