...
Defines the custom model-provider registration. Custom / Ollama / local OpenAI-compatible endpoint
...
| File                       | Responsibility                            |
| -------------------------- | ----------------------------------------- |
| [\_\_init\_\_.py](__init__.py) | Custom / Ollama (local) provider profile. |
