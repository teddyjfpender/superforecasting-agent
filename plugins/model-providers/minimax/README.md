...
Defines the minimax model-provider registration. MiniMax M-series (global + China + OAuth)
...
| File                       | Responsibility                                     |
| -------------------------- | -------------------------------------------------- |
| [\_\_init\_\_.py](__init__.py) | MiniMax provider profiles (international + China). |
