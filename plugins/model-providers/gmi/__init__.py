...
from superforecasting_agent import __version__ as _AGENT_VERSION
...
gmi = ProviderProfile(
    ...
    auth_type="api_key",
    # Attribution so GMI can identify traffic from Superforecasting Agent.
    ...
    default_headers={"User-Agent": f"SuperforecastingAgent/{_AGENT_VERSION}"},
