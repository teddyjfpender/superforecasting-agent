...
def _load_config() -> dict:
    ...
    profile_path = get_agent_home() / "hindsight" / "config.json"
...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        self._retain_context = "conversation between Superforecasting Agent and the User"
    ...
    def post_setup(self, hermes_home: str, config: dict) -> None:
        ...
        from superforecasting_agent.runtime.memory_setup import _curses_select
    ...
    def get_config_schema(self):
        return [
            ...
            {"key": "retain_context", "description": "Context label for retained memories", "default": "conversation between Superforecasting Agent and the User"},
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._retain_context = self._config.get("retain_context", "conversation between Superforecasting Agent and the User")
