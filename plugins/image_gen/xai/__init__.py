...
class XAIImageGenProvider(ImageGenProvider):
    ...
    def get_setup_schema(self) -> Dict[str, Any]:
        ...
        # hook (``superforecasting_agent/runtime/tools_config.py``); identical to the TTS / video
        ...
        **kwargs: Any,
        ...
        if not api_key:
            return error_response(
                error="No xAI credentials found. Configure xAI OAuth in `superforecasting-agent model` or set XAI_API_KEY.",
