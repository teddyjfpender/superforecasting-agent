# Forecast Achievements Performance Implementation Plan
...
- Snapshot persisted at `$SUPERFORECASTING_AGENT_HOME/plugins/hermes-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `$SUPERFORECASTING_AGENT_HOME/plugins/hermes-achievements/scan_checkpoint.json`.
