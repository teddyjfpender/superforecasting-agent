# Forecast Achievements Implementation Spec
...
- persisted runtime files:
  - `$SUPERFORECASTING_AGENT_HOME/plugins/hermes-achievements/state.json` (existing unlock state)
  - `$SUPERFORECASTING_AGENT_HOME/plugins/hermes-achievements/scan_snapshot.json` (new)
  - `$SUPERFORECASTING_AGENT_HOME/plugins/hermes-achievements/scan_checkpoint.json` (new)
