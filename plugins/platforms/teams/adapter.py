"""
Microsoft Teams platform adapter for Superforecasting Agent.
...
async def _standalone_send(
    ...
    *,
    ...
    hook, ``deliver=teams`` cron jobs fail with ``No live adapter for platform``.
...
def interactive_setup() -> None:
    ...
    print()
    print_success("Teams configuration saved to the active Superforecasting Agent .env")
