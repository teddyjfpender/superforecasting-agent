...
Dashboard plugin discovery, slots and page integration.
...
| File                             | Responsibility |
| -------------------------------- | -------------- |
| [PluginPage.tsx](PluginPage.tsx) | PluginPage.    |
| [index.ts](index.ts)             | index.         |
| [registry.ts](registry.ts)       | registry.      |
| [slots.ts](slots.ts)             | slots.         |
| [types.ts](types.ts)             | types.         |
| [usePlugins.ts](usePlugins.ts)   | usePlugins.    |
