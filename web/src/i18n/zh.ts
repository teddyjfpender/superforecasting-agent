...
export const zh: Translations = {
  ...
  sessions: {
    title: "预测会话",
    searchPlaceholder: "搜索预测会话内容...",
    noSessions: "暂无预测会话",
    noMatch: "没有匹配的预测会话",
    startConversation: "开始预测会话或 CLI 运行后将显示在此处",
    noMessages: "暂无记录条目",
    untitledSession: "无标题预测会话",
    deleteSession: "删除预测会话",
    confirmDeleteTitle: "删除预测会话？",
    confirmDeleteMessage: "此操作将永久删除研究记录及其所有条目，无法恢复。",
    sessionDeleted: "预测会话已删除",
    failedToDelete: "删除预测会话失败",
  ...
  pluginsPage: {
    ...
    headline: "发现、安装、启用和更新 Superforecasting Agent 插件（对齐 `superforecasting-agent plugins` CLI）。",
  ...
  achievements: {
    hero: {
      ...
      scan_subtitle:
        "正在扫描 Superforecasting Agent 会话历史。在历史记录较多时，首次扫描可能需要 5–10 秒。",
    },
    actions: {
      rescan: "重新扫描",
    },
    stats: {
      ...
      latest: "最新",
      latest_hint_empty: "多多运行 Superforecasting Agent",
      none_yet: "暂无",
    },
    state: {
      unlocked: "已解锁",
    ...
    guide: {
      ...
      secret_header: "秘密成就",
      secret_body:
        "秘密成就会隐藏其确切触发条件。一旦 Superforecasting Agent 检测到相关信号，卡片将变为「已发现」并显示其要求。",
      scan_status_header: "扫描状态",
      scan_status_body:
        "Superforecasting Agent 正在对本地历史进行一次扫描，之后卡片会自动出现。即使这需要几秒钟，也没有卡住。",
