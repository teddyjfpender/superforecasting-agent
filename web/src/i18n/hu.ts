...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateAgent: "Superforecasting Agent frissítése",
    updatingAgent: "Superforecasting Agent frissítése…",
    waitingForOutput: "Várakozás a kimenetre…",
  },

  sessions: {
    title: "Előrejelzési munkamenetek",
    searchPlaceholder: "Keresés előrejelzési munkamenet tartalmában...",
    noSessions: "Még nincsenek előrejelzési munkamenetek",
    noMatch: "Nincs a keresésnek megfelelő előrejelzési munkamenet",
    startConversation: "Indítson előrejelzési munkamenetet vagy CLI-futtatást, hogy itt megjelenjen",
    noMessages: "Nincsenek átiratbejegyzések",
    untitledSession: "Névtelen előrejelzési munkamenet",
    deleteSession: "Előrejelzési munkamenet törlése",
    confirmDeleteTitle: "Törli az előrejelzési munkamenetet?",
    confirmDeleteMessage:
      "Ez véglegesen eltávolítja a kutatási átiratot és minden bejegyzését. A művelet nem vonható vissza.",
    sessionDeleted: "Előrejelzési munkamenet törölve",
    failedToDelete: "Nem sikerült törölni az előrejelzési munkamenetet",
  ...
  pluginsPage: {
    ...
    headline:
      "Superforecasting Agent-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `superforecasting-agent plugins` paritás).",
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.superforecasting-agent/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.superforecasting-agent/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.superforecasting-agent/skills/ mappából töltődnek be",
  ...
  achievements: {
    hero: {
      ...
      scan_subtitle:
        "Superforecasting Agent munkamenet-előzmények vizsgálata. Az első vizsgálat 5–10 másodpercig is eltarthat nagy előzmények esetén.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Legutóbbi",
      latest_hint_empty: "futtasd többet a Superforecasting Agentt",
      none_yet: "Még semmi",
    },
    state: {
      unlocked: "Feloldva",
    ...
    guide: {
      ...
      secret_body:
        "A titkos teljesítmények elrejtik a pontos kiváltó eseményt. Amint a Superforecasting Agent kapcsolódó jelet észlel, a kártya Felfedezettre vált, és megjeleníti a követelményt.",
      scan_status_header: "Vizsgálat állapota",
      scan_status_body:
        "A Superforecasting Agent egyszer átvizsgálja a helyi előzményeket, majd a kártyák automatikusan megjelennek. Semmi sem akadt el, ha ez néhány másodpercig tart.",
