...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateAgent: "Superforecasting Agent'i Güncelle",
    updatingAgent: "Superforecasting Agent güncelleniyor…",
    waitingForOutput: "Çıktı bekleniyor…",
  },

  sessions: {
    title: "Tahmin oturumları",
    searchPlaceholder: "Tahmin oturumu içeriğinde ara...",
    noSessions: "Henüz tahmin oturumu yok",
    noMatch: "Aramanızla eşleşen tahmin oturumu yok",
    startConversation: "Burada görmek için bir tahmin oturumu veya CLI çalıştırması başlatın",
    noMessages: "Döküm kaydı yok",
    untitledSession: "Başlıksız tahmin oturumu",
    deleteSession: "Tahmin oturumunu sil",
    confirmDeleteTitle: "Tahmin oturumu silinsin mi?",
    confirmDeleteMessage:
      "Bu, araştırma dökümünü ve tüm kayıtlarını kalıcı olarak siler. Bu işlem geri alınamaz.",
    sessionDeleted: "Tahmin oturumu silindi",
    failedToDelete: "Tahmin oturumu silinemedi",
  ...
  pluginsPage: {
    ...
    headline:
      "Superforecasting Agent eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`superforecasting-agent plugins` ile eşdeğer).",
  ...
  achievements: {
    hero: {
      ...
      scan_subtitle:
        "Superforecasting Agent oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "Superforecasting Agent'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. Superforecasting Agent ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "Superforecasting Agent yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
