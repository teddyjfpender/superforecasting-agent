...
export const uk: Translations = {
  ...
  status: {
    ...
    stopped: "Зупинено",
    updateAgent: "Оновити Superforecasting Agent",
    updatingAgent: "Оновлення Superforecasting Agent…",
    waitingForOutput: "Очікування виводу…",
  },

  sessions: {
    title: "Прогнозні сесії",
    searchPlaceholder: "Пошук у вмісті прогнозних сесій...",
    noSessions: "Поки немає прогнозних сесій",
    noMatch: "Жодна прогнозна сесія не відповідає вашому пошуку",
    startConversation: "Почніть прогнозну сесію або запуск CLI, щоб побачити її тут",
    noMessages: "Немає записів протоколу",
    untitledSession: "Прогнозна сесія без назви",
    deleteSession: "Видалити прогнозну сесію",
    confirmDeleteTitle: "Видалити прогнозну сесію?",
    confirmDeleteMessage:
      "Це назавжди видалить дослідницький протокол і всі його записи. Цю дію не можна скасувати.",
    sessionDeleted: "Прогнозну сесію видалено",
    failedToDelete: "Не вдалося видалити прогнозну сесію",
  ...
  pluginsPage: {
    ...
    headline:
      "Знаходьте, встановлюйте, вмикайте та оновлюйте плагіни Superforecasting Agent (паритет з `superforecasting-agent plugins`).",
    ...
    removeConfirm: "Видалити цей плагін з ~/.superforecasting-agent/plugins/?",
    removeHint: "Видаляти можна лише плагіни, встановлені користувачем у ~/.superforecasting-agent/plugins.",
  ...
  skills: {
    ...
    filters: "Фільтри",
    noSkills: "Навичок не знайдено. Навички завантажуються з ~/.superforecasting-agent/skills/",
  ...
  achievements: {
    hero: {
      ...
      scan_subtitle:
        "Сканування історії сеансів Superforecasting Agent. Перше сканування на великих історіях може тривати 5–10 секунд.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Останнє",
      latest_hint_empty: "запускайте Superforecasting Agent частіше",
      none_yet: "Поки немає",
    },
    state: {
      unlocked: "Розблоковано",
    ...
    guide: {
      ...
      secret_body:
        "Секрети приховують свій точний тригер. Щойно Superforecasting Agent побачить пов'язаний сигнал, картка стає Виявленою та показує свою умову.",
      scan_status_header: "Стан сканування",
      scan_status_body:
        "Superforecasting Agent одноразово сканує локальну історію, а потім картки з'являться автоматично. Якщо це триває кілька секунд — нічого не зависло.",
