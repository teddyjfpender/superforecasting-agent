...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateAgent: "Aggiorna Superforecasting Agent",
    updatingAgent: "Aggiornamento di Superforecasting Agent…",
    waitingForOutput: "In attesa di output…",
  },

  sessions: {
    title: "Sessioni di previsione",
    searchPlaceholder: "Cerca nel contenuto delle sessioni di previsione...",
    noSessions: "Nessuna sessione di previsione",
    noMatch: "Nessuna sessione di previsione corrisponde alla ricerca",
    startConversation: "Avvia una sessione di previsione o un'esecuzione CLI per vederla qui",
    noMessages: "Nessuna voce di trascrizione",
    untitledSession: "Sessione di previsione senza titolo",
    deleteSession: "Elimina sessione di previsione",
    confirmDeleteTitle: "Eliminare la sessione di previsione?",
    confirmDeleteMessage:
      "Questa operazione rimuove definitivamente la trascrizione di ricerca e tutte le sue voci. Non può essere annullata.",
    sessionDeleted: "Sessione di previsione eliminata",
    failedToDelete: "Eliminazione della sessione di previsione non riuscita",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Superforecasting Agent (parità con `superforecasting-agent plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.superforecasting-agent/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.superforecasting-agent/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.superforecasting-agent/skills/",
  ...
  achievements: {
    hero: {
      ...
      scan_subtitle:
        "Scansione della cronologia delle sessioni Superforecasting Agent in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa Superforecasting Agent di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando Superforecasting Agent rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "Superforecasting Agent sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
