...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateAgent: "Superforecasting Agent aktualisieren",
    updatingAgent: "Superforecasting Agent wird aktualisiert…",
    waitingForOutput: "Warte auf Ausgabe…",
  },

  sessions: {
    title: "Prognosesitzungen",
    searchPlaceholder: "Prognosesitzungsinhalte suchen...",
    noSessions: "Noch keine Prognosesitzungen",
    noMatch: "Keine Prognosesitzungen entsprechen deiner Suche",
    startConversation: "Starte eine Prognosesitzung oder einen CLI-Lauf, um sie hier zu sehen",
    noMessages: "Keine Protokolleinträge",
    untitledSession: "Prognosesitzung ohne Titel",
    deleteSession: "Prognosesitzung löschen",
    confirmDeleteTitle: "Prognosesitzung löschen?",
    confirmDeleteMessage:
      "Dies entfernt das Forschungsprotokoll und alle Einträge dauerhaft. Dies kann nicht rückgängig gemacht werden.",
    sessionDeleted: "Prognosesitzung gelöscht",
    failedToDelete: "Prognosesitzung konnte nicht gelöscht werden",
    resumeInDesk: "Resume in Forecast Desk",
    previousPage: "Vorherige Seite",
    nextPage: "Nächste Seite",
    roles: {
      user: "Benutzer",
      assistant: "Prognostiker",
      system: "System",
      tool: "Werkzeug",
    },
  },
  ...
  pluginsPage: {
    ...
    headline:
      "Superforecasting Agent-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `superforecasting-agent plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.superforecasting-agent/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.superforecasting-agent/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.superforecasting-agent/skills/ geladen",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare Superforecasting Agent-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "Superforecasting Agent-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze Superforecasting Agent mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald Superforecasting Agent ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "Superforecasting Agent scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
