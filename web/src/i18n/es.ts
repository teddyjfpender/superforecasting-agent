...
export const es: Translations = {
  ...
  status: {
    ...
    stopped: "Detenido",
    updateAgent: "Actualizar Superforecasting Agent",
    updatingAgent: "Actualizando Superforecasting Agent…",
    waitingForOutput: "Esperando salida…",
  },

  sessions: {
    title: "Sesiones de previsión",
    searchPlaceholder: "Buscar contenido de sesiones de previsión...",
    noSessions: "Aún no hay sesiones de previsión",
    noMatch: "Ninguna sesión de previsión coincide con tu búsqueda",
    startConversation: "Inicia una sesión de previsión o una ejecución CLI para verla aquí",
    noMessages: "Sin entradas de transcripción",
    untitledSession: "Sesión de previsión sin título",
    deleteSession: "Eliminar sesión de previsión",
    confirmDeleteTitle: "¿Eliminar sesión de previsión?",
    confirmDeleteMessage:
      "Esto elimina permanentemente la transcripción de investigación y todas sus entradas. No se puede deshacer.",
    sessionDeleted: "Sesión de previsión eliminada",
    failedToDelete: "No se pudo eliminar la sesión de previsión",
    resumeInDesk: "Resume in Forecast Desk",
    previousPage: "Página anterior",
    nextPage: "Página siguiente",
    roles: {
      user: "Usuario",
      assistant: "Pronosticador",
      system: "Sistema",
      tool: "Herramienta",
    },
  },
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de Superforecasting Agent (equivalente a `superforecasting-agent plugins`).",
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.superforecasting-agent/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.superforecasting-agent/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.superforecasting-agent/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Insignias coleccionables de Superforecasting Agent ganadas a partir del historial real de sesiones. Los logros conocidos no completados se muestran como Descubiertos; los logros secretos permanecen ocultos hasta que aparece el primer comportamiento coincidente.",
      scan_subtitle:
        "Escaneando el historial de sesiones de Superforecasting Agent. El primer escaneo puede tardar 5–10 segundos en historiales grandes.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Más reciente",
      latest_hint_empty: "usa Superforecasting Agent más",
    ...
    guide: {
      ...
      secret_body:
        "Los secretos ocultan su disparador exacto. Una vez que Superforecasting Agent detecta una señal relacionada, la tarjeta pasa a Descubierto y muestra su requisito.",
      scan_status_header: "Estado del escaneo",
      scan_status_body:
        "Superforecasting Agent está escaneando el historial local una vez, después las tarjetas aparecerán automáticamente. No hay nada bloqueado si tarda unos segundos.",
