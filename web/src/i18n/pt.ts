...
export const pt: Translations = {
  ...
  status: {
    ...
    stopped: "Parado",
    updateAgent: "Atualizar Superforecasting Agent",
    updatingAgent: "A atualizar Superforecasting Agent…",
    waitingForOutput: "À espera de saída…",
  },

  sessions: {
    title: "Sessões de previsão",
    searchPlaceholder: "Pesquisar conteúdo das sessões de previsão...",
    noSessions: "Ainda não há sessões de previsão",
    noMatch: "Nenhuma sessão de previsão corresponde à pesquisa",
    startConversation: "Inicie uma sessão de previsão ou execução CLI para a ver aqui",
    noMessages: "Sem entradas de transcrição",
    untitledSession: "Sessão de previsão sem título",
    deleteSession: "Eliminar sessão de previsão",
    confirmDeleteTitle: "Eliminar sessão de previsão?",
    confirmDeleteMessage:
      "Esta ação remove permanentemente a transcrição de investigação e todas as suas entradas. Não é possível anular.",
    sessionDeleted: "Sessão de previsão eliminada",
    failedToDelete: "Falha ao eliminar a sessão de previsão",
  ...
  pluginsPage: {
    ...
    headline:
      "Descobrir, instalar, ativar e atualizar plugins Superforecasting Agent (paridade com `superforecasting-agent plugins`).",
  ...
  achievements: {
    hero: {
      ...
      scan_subtitle:
        "A analisar o histórico de sessões do Superforecasting Agent. A primeira análise pode demorar 5–10 segundos em históricos extensos.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Mais recente",
      latest_hint_empty: "execute mais o Superforecasting Agent",
    ...
    guide: {
      ...
      secret_body:
        "As secretas escondem o seu acionador exato. Assim que o Superforecasting Agent detetar um sinal relacionado, o cartão passa a Descoberta e mostra o requisito.",
      scan_status_header: "Estado da análise",
      scan_status_body:
        "O Superforecasting Agent analisa o histórico local uma vez e depois os cartões aparecem automaticamente. Nada está bloqueado se isto demorar alguns segundos.",
