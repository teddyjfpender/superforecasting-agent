...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateAgent: "Werk Superforecasting Agent op",
    updatingAgent: "Besig om Superforecasting Agent op te werk…",
    waitingForOutput: "Wag vir uitset…",
  },

  sessions: {
    title: "Voorspellingsessies",
    searchPlaceholder: "Soek voorspellingsessie-inhoud...",
    noSessions: "Nog geen voorspellingsessies nie",
    noMatch: "Geen voorspellingsessies stem ooreen met jou soektog nie",
    startConversation: "Begin 'n voorspellingsessie of CLI-loop om dit hier te sien",
    noMessages: "Geen transkripsie-inskrywings",
    untitledSession: "Voorspellingsessie sonder titel",
    deleteSession: "Skrap voorspellingsessie",
    confirmDeleteTitle: "Skrap voorspellingsessie?",
    confirmDeleteMessage:
      "Dit verwyder die navorsingstranskripsie en al sy inskrywings permanent. Dit kan nie ongedaan gemaak word nie.",
    sessionDeleted: "Voorspellingsessie geskrap",
    failedToDelete: "Kon nie voorspellingsessie skrap nie",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Superforecasting Agent-inproppe op (`superforecasting-agent plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.superforecasting-agent/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.superforecasting-agent/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.superforecasting-agent/skills/",
  ...
  achievements: {
    hero: {
      ...
      scan_subtitle:
        "Superforecasting Agent-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik Superforecasting Agent meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra Superforecasting Agent 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "Superforecasting Agent skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
