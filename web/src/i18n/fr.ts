...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateAgent: "Mettre à jour Superforecasting Agent",
    updatingAgent: "Mise à jour de Superforecasting Agent…",
    waitingForOutput: "En attente de la sortie…",
  },

  sessions: {
    title: "Sessions de prévision",
    searchPlaceholder: "Rechercher dans les sessions de prévision...",
    noSessions: "Aucune session de prévision pour l'instant",
    noMatch: "Aucune session de prévision ne correspond à votre recherche",
    startConversation: "Démarrez une session de prévision ou une exécution CLI pour la voir ici",
    noMessages: "Aucune entrée de transcription",
    untitledSession: "Session de prévision sans titre",
    deleteSession: "Supprimer la session de prévision",
    confirmDeleteTitle: "Supprimer la session de prévision ?",
    confirmDeleteMessage:
      "Cela supprime définitivement la transcription de recherche et toutes ses entrées. Cette action est irréversible.",
    sessionDeleted: "Session de prévision supprimée",
    failedToDelete: "Échec de la suppression de la session de prévision",
    resumeInDesk: "Resume in Forecast Desk",
    previousPage: "Page précédente",
    nextPage: "Page suivante",
    roles: {
      user: "Utilisateur",
      assistant: "Prévisionniste",
      system: "Système",
      tool: "Outil",
    },
  },
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Superforecasting Agent (parité avec `superforecasting-agent plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.superforecasting-agent/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.superforecasting-agent/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.superforecasting-agent/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badges Superforecasting Agent à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Superforecasting Agent en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Superforecasting Agent davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Superforecasting Agent détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Superforecasting Agent analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
