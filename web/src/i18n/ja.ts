...
export const ja: Translations = {
  ...
  sessions: {
    title: "予測セッション",
    searchPlaceholder: "予測セッションの内容を検索...",
    noSessions: "まだ予測セッションがありません",
    noMatch: "検索条件に一致する予測セッションはありません",
    startConversation: "予測セッションまたは CLI 実行を開始するとここに表示されます",
    noMessages: "記録エントリがありません",
    untitledSession: "無題の予測セッション",
    deleteSession: "予測セッションを削除",
    confirmDeleteTitle: "予測セッションを削除しますか？",
    confirmDeleteMessage:
      "リサーチ記録とそのすべてのエントリが完全に削除されます。この操作は取り消せません。",
    sessionDeleted: "予測セッションを削除しました",
    failedToDelete: "予測セッションの削除に失敗しました",
  ...
  pluginsPage: {
    ...
    headline:
      "Superforecasting Agent プラグインを発見、インストール、有効化、更新します (`superforecasting-agent plugins` 相当)。",
    ...
    removeConfirm: "このプラグインを ~/.superforecasting-agent/plugins/ から削除しますか？",
    removeHint: "削除できるのは ~/.superforecasting-agent/plugins 配下のユーザーがインストールしたプラグインのみです。",
  ...
  skills: {
    ...
    categories: "カテゴリ",
    filters: "フィルター",
    noSkills: "スキルが見つかりません。スキルは ~/.superforecasting-agent/skills/ から読み込まれます",
  ...
  achievements: {
    hero: {
      ...
      scan_subtitle:
        "Superforecasting Agent のセッション履歴をスキャンしています。履歴が大きい場合、初回スキャンには 5～10 秒かかることがあります。",
    },
    actions: {
      rescan: "再スキャン",
    },
    stats: {
      ...
      latest: "最新",
      latest_hint_empty: "Superforecasting Agent をもっと使ってみてください",
      none_yet: "まだありません",
    },
    state: {
      unlocked: "解除済み",
    ...
    guide: {
      ...
      secret_body:
        "シークレットはトリガー条件を隠しています。Superforecasting Agent が関連するシグナルを検出すると、カードは「Discovered」になり、要件が表示されます。",
      scan_status_header: "スキャン状況",
      scan_status_body:
        "Superforecasting Agent はローカル履歴を一度スキャンし、その後カードが自動的に表示されます。数秒かかってもスタックしているわけではありません。",
