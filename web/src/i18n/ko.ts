...
export const ko: Translations = {
  ...
  status: {
    ...
    stopped: "중지됨",
    updateAgent: "Superforecasting Agent 업데이트",
    updatingAgent: "Superforecasting Agent 업데이트 중…",
    waitingForOutput: "출력 대기 중…",
  },

  sessions: {
    title: "예측 세션",
    searchPlaceholder: "예측 세션 내용 검색...",
    noSessions: "아직 예측 세션이 없습니다",
    noMatch: "검색과 일치하는 예측 세션이 없습니다",
    startConversation: "예측 세션 또는 CLI 실행을 시작하면 여기에 표시됩니다",
    noMessages: "기록 항목이 없습니다",
    untitledSession: "제목 없는 예측 세션",
    deleteSession: "예측 세션 삭제",
    confirmDeleteTitle: "예측 세션을 삭제하시겠습니까?",
    confirmDeleteMessage:
      "이 작업은 리서치 기록과 모든 항목을 영구적으로 제거합니다. 되돌릴 수 없습니다.",
    sessionDeleted: "예측 세션이 삭제되었습니다",
    failedToDelete: "예측 세션 삭제에 실패했습니다",
  ...
  pluginsPage: {
    ...
    headline:
      "Superforecasting Agent 플러그인을 검색, 설치, 활성화 및 업데이트합니다 (`superforecasting-agent plugins` 동등).",
    ...
    removeConfirm: "~/.superforecasting-agent/plugins/에서 이 플러그인을 제거하시겠습니까?",
    removeHint: "~/.superforecasting-agent/plugins 아래에 사용자가 설치한 플러그인만 제거할 수 있습니다.",
  ...
  skills: {
    ...
    categories: "카테고리",
    filters: "필터",
    noSkills: "스킬을 찾을 수 없습니다. 스킬은 ~/.superforecasting-agent/skills/ 에서 로드됩니다",
  ...
  achievements: {
    hero: {
      ...
      scan_subtitle:
        "Superforecasting Agent 세션 기록을 스캔하고 있습니다. 기록이 많으면 첫 스캔에 5~10초가 걸릴 수 있습니다.",
    },
    actions: {
      rescan: "다시 스캔",
    },
    stats: {
      ...
      latest: "최근",
      latest_hint_empty: "Superforecasting Agent를 더 사용해 보세요",
      none_yet: "아직 없음",
    },
    state: {
      unlocked: "해제됨",
    ...
    guide: {
      ...
      secret_body:
        "시크릿은 정확한 트리거 조건을 숨깁니다. Superforecasting Agent가 관련 신호를 감지하면 카드가 Discovered로 바뀌고 요건이 표시됩니다.",
      scan_status_header: "스캔 상태",
      scan_status_body:
        "Superforecasting Agent는 로컬 기록을 한 번 스캔한 뒤 카드를 자동으로 표시합니다. 몇 초 걸리더라도 멈춘 것이 아닙니다.",
