...
export const ga: Translations = {
  ...
  status: {
    ...
    stopped: "Stoptha",
    updateAgent: "Nuashonraigh Superforecasting Agent",
    updatingAgent: "Ag nuashonrú Superforecasting Agent…",
    waitingForOutput: "Ag fanacht le haschur…",
  },

  sessions: {
    title: "Seisiúin réamhaisnéise",
    searchPlaceholder: "Cuardaigh ábhar seisiúin réamhaisnéise...",
    noSessions: "Gan seisiúin réamhaisnéise fós",
    noMatch: "Níl seisiún réamhaisnéise ar bith ag teacht le do chuardach",
    startConversation: "Tosaigh seisiún réamhaisnéise nó rith CLI chun é a fheiceáil anseo",
    noMessages: "Gan iontrálacha tras-scríbhinne",
    untitledSession: "Seisiún réamhaisnéise gan teideal",
    deleteSession: "Scrios seisiún réamhaisnéise",
    confirmDeleteTitle: "Scrios seisiún réamhaisnéise?",
    confirmDeleteMessage:
      "Baineann sé seo an tras-scríbhinn taighde agus a hiontrálacha go léir go buan. Ní féidir é seo a chealú.",
    sessionDeleted: "Seisiún réamhaisnéise scriosta",
    failedToDelete: "Theip ar scriosadh an tseisiúin réamhaisnéise",
  ...
  pluginsPage: {
    ...
    headline:
      "Faigh, suiteáil, cumasaigh agus nuashonraigh plugins Superforecasting Agent (paireacht le `superforecasting-agent plugins`).",
  ...
  achievements: {
    hero: {
      ...
      scan_subtitle:
        "Stair session Superforecasting Agent á scanadh. Is féidir leis an gcéad scan 5–10 soicind a thógáil ar staireanna móra.",
    },
    actions: {
      rescan: "Athscan",
    },
    stats: {
      ...
      latest_hint_empty: "rith Superforecasting Agent níos mó",
    ...
    guide: {
      ...
      secret_body:
        "Coinníonn rúin a dtruicear cruinn faoi cheilt. Nuair a fheiceann Superforecasting Agent comhartha gaolmhar, athraíonn an cárta go Aimsithe agus taispeánann sé a riachtanas.",
      scan_status_header: "Stádas an scanta",
      scan_status_body:
        "Scanann Superforecasting Agent an stair logánta uair amháin, ansin feicfear cártaí go huathoibríoch. Níl aon rud sáinnithe má thógann sé cúpla soicind.",
