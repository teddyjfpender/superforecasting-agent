...
export const ru: Translations = {
  ...
  status: {
    ...
    stopped: "Остановлено",
    updateAgent: "Обновить Superforecasting Agent",
    updatingAgent: "Обновление Superforecasting Agent…",
    waitingForOutput: "Ожидание вывода…",
  },

  sessions: {
    title: "Прогнозные сессии",
    searchPlaceholder: "Поиск по содержимому прогнозных сессий...",
    noSessions: "Прогнозных сессий пока нет",
    noMatch: "Нет прогнозных сессий, соответствующих запросу",
    startConversation: "Начните прогнозную сессию или CLI-запуск, чтобы увидеть его здесь",
    noMessages: "Нет записей протокола",
    untitledSession: "Прогнозная сессия без названия",
    deleteSession: "Удалить прогнозную сессию",
    confirmDeleteTitle: "Удалить прогнозную сессию?",
    confirmDeleteMessage:
      "Это безвозвратно удалит исследовательский протокол и все его записи. Действие нельзя отменить.",
    sessionDeleted: "Прогнозная сессия удалена",
    failedToDelete: "Не удалось удалить прогнозную сессию",
  ...
  pluginsPage: {
    ...
    headline:
      "Поиск, установка, включение и обновление плагинов Superforecasting Agent (аналог `superforecasting-agent plugins`).",
    ...
    removeConfirm: "Удалить этот плагин из ~/.superforecasting-agent/plugins/?",
    removeHint: "Удалять можно только плагины, установленные пользователем в ~/.superforecasting-agent/plugins.",
  ...
  skills: {
    ...
    filters: "Фильтры",
    noSkills: "Навыки не найдены. Навыки загружаются из ~/.superforecasting-agent/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Коллекционные значки Superforecasting Agent, полученные на основе реальной истории сессий. Известные, но ещё не полученные достижения отображаются как «Обнаруженные»; «Секретные» достижения остаются скрытыми до появления первого подходящего поведения.",
      scan_subtitle:
        "Анализ истории сессий Superforecasting Agent. Первое сканирование может занять 5–10 секунд при большой истории.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Последнее",
      latest_hint_empty: "запускайте Superforecasting Agent чаще",
      none_yet: "Пока нет",
    },
    state: {
      unlocked: "Разблокировано",
    ...
    guide: {
      ...
      secret_body:
        "Секретные достижения скрывают свой точный триггер. Как только Superforecasting Agent обнаруживает связанный сигнал, карточка становится «Обнаруженной» и показывает требование.",
      scan_status_header: "Статус сканирования",
      scan_status_body:
        "Superforecasting Agent сканирует локальную историю один раз, затем карточки появятся автоматически. Если это занимает несколько секунд — ничего не зависло.",
