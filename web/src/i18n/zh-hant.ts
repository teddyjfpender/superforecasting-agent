...
export const zhHant: Translations = {
  ...
  status: {
    ...
    stopped: "已停止",
    updateAgent: "更新 Superforecasting Agent",
    updatingAgent: "正在更新 Superforecasting Agent…",
    waitingForOutput: "等待輸出…",
  },

  sessions: {
    title: "預測工作階段",
    searchPlaceholder: "搜尋預測工作階段內容...",
    noSessions: "尚無預測工作階段",
    noMatch: "沒有符合的預測工作階段",
    startConversation: "開始預測工作階段或 CLI 執行後將顯示於此",
    noMessages: "尚無記錄項目",
    untitledSession: "未命名預測工作階段",
    deleteSession: "刪除預測工作階段",
    confirmDeleteTitle: "刪除預測工作階段？",
    confirmDeleteMessage:
      "此操作將永久移除研究記錄及其所有項目，無法復原。",
    sessionDeleted: "預測工作階段已刪除",
    failedToDelete: "刪除預測工作階段失敗",
  ...
  pluginsPage: {
    ...
    headline:
      "探索、安裝、啟用並更新 Superforecasting Agent 外掛（對齊 `superforecasting-agent plugins` CLI）。",
    ...
    removeConfirm: "從 ~/.superforecasting-agent/plugins/ 移除此外掛？",
    removeHint: "僅可移除位於 ~/.superforecasting-agent/plugins 下使用者安裝的外掛。",
  ...
  skills: {
    ...
    categories: "分類",
    filters: "篩選",
    noSkills: "找不到技能。技能由 ~/.superforecasting-agent/skills/ 載入",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "從真實工作階段歷史中獲得的 Superforecasting Agent 可收集徽章。已知尚未達成的成就會顯示為「已發現」；秘密成就在首次出現相符行為之前保持隱藏。",
      scan_subtitle:
        "正在掃描 Superforecasting Agent 工作階段歷史。在歷史紀錄較多時，首次掃描可能需要 5–10 秒。",
    },
    actions: {
      rescan: "重新掃描",
    },
    stats: {
      ...
      latest: "最新",
      latest_hint_empty: "多多執行 Superforecasting Agent",
      none_yet: "尚無",
    },
    state: {
      unlocked: "已解鎖",
    ...
    guide: {
      ...
      secret_header: "秘密成就",
      secret_body:
        "秘密成就會隱藏其確切觸發條件。一旦 Superforecasting Agent 偵測到相關訊號，卡片便會變為「已發現」並顯示其需求。",
      scan_status_header: "掃描狀態",
      scan_status_body:
        "Superforecasting Agent 正在對本機歷史進行一次掃描，之後卡片會自動出現。即使需要幾秒鐘，也並未卡住。",
