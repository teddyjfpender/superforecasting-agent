...
export const en: Translations = {
  ...
  status: {
    ...
    actions: "Actions",
    agent: "Agent",
    activeSessions: "Active Forecast Sessions",
    connected: "Connected",
    ...
    platformError: "error",
    recentSessions: "Recent Forecast Sessions",
  ...
  sessions: {
    ...
    noSessions: "No forecast sessions yet",
    noMatch: "No forecast sessions match your search",
    startConversation: "Start a forecast session or CLI run to see it here",
    noMessages: "No transcript entries",
    untitledSession: "Untitled forecast session",
    deleteSession: "Delete forecast session",
    confirmDeleteTitle: "Delete forecast session?",
    confirmDeleteMessage:
      "This permanently removes the research transcript and all of its entries. This cannot be undone.",
    sessionDeleted: "Forecast session deleted",
    failedToDelete: "Failed to delete forecast session",
  ...
  analytics: {
    ...
    totalSessions: "Total Forecast Sessions",
    apiCalls: "API Calls",
    ...
    startSession: "Start a forecast session to see analytics here",
    date: "Date",
    model: "Model",
    tokens: "Tokens",
    perDayAvg: "/day avg",
  ...
  models: {
    ...
    tokens: "tokens",
    sessions: "forecast sessions",
    avgPerSession: "avg/forecast session",
    apiCalls: "API calls",
    toolCalls: "tool calls",
    noModelsData: "No model usage data for this period",
    startSession: "Start a forecast session to see model data here",
  },
  ...
  profiles: {
    ...
    confirmDeleteMessage:
      "This permanently deletes profile '{name}' — config, keys, memories, forecast sessions, forecast skills, cron jobs. Cannot be undone.",
    created: "Created",
    deleted: "Deleted",
    renamed: "Renamed",
  },
