...
const BUILTIN_NAV_REST: NavItem[] = [
  ...
  { path: "/skills", labelKey: "skills", label: "Forecast Skills", icon: Package },
  { path: "/plugins", labelKey: "plugins", label: "Extensions", icon: Puzzle },
...
export default function App() {
  ...
  const embeddedDesk = isDashboardForecastDeskEnabled();
          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="forecast-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="forecast-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({ onNavigate }: { onNavigate: () => void }) {
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updateAgent,
      runningLabel: t.status.updatingAgent,
      spin: false,
    },
  ];
