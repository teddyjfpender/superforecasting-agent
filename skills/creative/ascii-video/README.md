...
Built for Superforecasting Agent. Usable in any coding agent. Canonical source lives here; synced to the inherited `skills/creative/ascii-video` tree via PR.
