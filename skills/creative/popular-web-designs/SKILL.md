...
version: 1.0.0
author: Teknium, Superforecasting Agent (design systems sourced from VoltAgent/awesome-design-md)
license: MIT
...
Each template includes a **Superforecasting Agent Implementation Notes** block at the top with:
...
<head>
  ...
  <!-- Paste the Google Fonts <link> from the template's Superforecasting Agent notes -->
