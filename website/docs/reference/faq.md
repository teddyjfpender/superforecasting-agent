...
#### WSL: Gateway keeps disconnecting or `superforecasting-agent gateway start` fails {#wsl-gateway-keeps-disconnecting-or-superforecasting-agent-gateway-start-fails}
