...
| `SUPERFORECASTING_AGENT_TUI_LIGHT` / `FORECAST_TUI_LIGHT` / `HERMES_TUI_LIGHT` | Force light or dark TUI detection with a boolean value. This takes precedence over theme/background hints. |
| `SUPERFORECASTING_AGENT_TUI_BACKGROUND` / `FORECAST_TUI_BACKGROUND` / `HERMES_TUI_BACKGROUND` | Provide a 3- or 6-digit background color hint for automatic TUI light/dark selection. |
