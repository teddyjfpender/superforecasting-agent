...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/teddyjfpender/superforecasting-agent/tree/superforecasting-agent-snapshot" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
| Adapters | Import context from RSS/Atom, GDELT, FRED, BLS, World Bank, IMF DataMapper, Stooq, Yahoo Finance, CoinGecko, SEC EDGAR, arXiv, OpenAlex, PubMed, Wikipedia, Wikimedia pageviews, GitHub releases/issues/commits, PyPI, npm, Hacker News, Reddit, Federal Register, CourtListener, NVD, CISA KEV, Open-Meteo, USGS, NASA EONET, NWS alerts, OWID, WHO GHO, FEMA disaster declarations, Metaculus, Manifold, Polymarket, Kalshi, CSV/JSON, and generic URLs. |
...
This fork still carries substantial inherited runtime code and documentation. Generic chat, skills, messaging gateways, voice, the embedded Forecast Desk, and broad platform integrations remain available when useful, but they are subordinate to the forecast lifecycle.
