...
| Adapters | Import context from RSS/Atom, GDELT, FRED, BLS, World Bank, Stooq, Yahoo Finance, CoinGecko, SEC EDGAR, arXiv, OpenAlex, PubMed, Wikipedia, Wikimedia pageviews, GitHub releases/issues/commits, PyPI, npm, Hacker News, Reddit, Federal Register, CourtListener, NVD, CISA KEV, Open-Meteo, USGS, NASA EONET, NWS alerts, OWID, WHO GHO, Metaculus, Manifold, Polymarket, Kalshi, CSV/JSON, and generic URLs. |
