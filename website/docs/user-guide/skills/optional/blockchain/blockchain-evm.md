...
| | |
|---|---|
| Source | Optional — install with `superforecasting-agent skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Superforecasting Agent |
| License | MIT |
...
Helper script path: `~/.superforecasting-agent/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.superforecasting-agent/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.superforecasting-agent/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.superforecasting-agent/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
