...
The script reads `~/.superforecasting-agent/.env` for two optional defaults:
...
Helper script: `~/.superforecasting-agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.superforecasting-agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.superforecasting-agent/.env`.
...
```bash
python3 ~/.superforecasting-agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.superforecasting-agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
