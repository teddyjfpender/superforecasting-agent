...
| | |
|---|---|
| Source | Optional — install with `superforecasting-agent skills install official/research/qmd` |
...
Superforecasting Agent via the native MCP client. This is the preferred
...
Then configure Superforecasting Agent to connect via HTTP:
