...
| | |
|---|---|
| Source | Optional — install with `superforecasting-agent skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Superforecasting Agent |
| License | MIT |
...
import upstream classes into Superforecasting Agent itself.
...
```bash
mkdir -p ~/.superforecasting-agent/cache/darwinian-evolver && cd ~/.superforecasting-agent/cache/darwinian-evolver
...
```bash
cd ~/.superforecasting-agent/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.superforecasting-agent/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.superforecasting-agent/skills/research/darwinian-evolver
DE_DIR=~/.superforecasting-agent/cache/darwinian-evolver/darwinian_evolver
