...
| | |
|---|---|
| Source | Optional — install with `superforecasting-agent skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Superforecasting Agent |
| License | MIT |
...
```
SCRIPT=~/.superforecasting-agent/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.superforecasting-agent/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
