...
- User wants **Superforecasting Agent itself to drive a browser** → use Superforecasting Agent's built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
