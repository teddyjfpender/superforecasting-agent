...
| | |
|---|---|
| Source | Optional — install with `superforecasting-agent skills install official/mcp/mcporter` |
...
# Machine-readable output (recommended for Superforecasting Agent)
