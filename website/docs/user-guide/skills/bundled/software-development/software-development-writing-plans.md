...
> **For Superforecasting Agent:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Superforecasting Agent tools to understand the project:
