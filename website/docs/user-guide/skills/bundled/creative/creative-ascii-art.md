...
| Version | `4.0.0` |
| Author | 0xbyt4, Superforecasting Agent |
| License | MIT |
...
```bash
python3 -m pyfiglet "FORECAST" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=FORECAST&font=Slant" | boxes -d stone
```
