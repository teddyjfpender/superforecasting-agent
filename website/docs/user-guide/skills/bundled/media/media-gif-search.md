...
Set your Tenor API key in your environment (add to `~/.superforecasting-agent/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/teddyjfpender/superforecasting-agent/blob/superforecasting-agent-snapshot/skills/media/gif-search/url)`
