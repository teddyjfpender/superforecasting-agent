"""Tests for _setup_feishu() in superforecasting_agent/runtime/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("superforecasting_agent.runtime.gateway.save_env_value", side_effect=mock_save), \
         patch("superforecasting_agent.runtime.gateway.get_env_value", side_effect=mock_get), \
         patch("superforecasting_agent.runtime.gateway.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("superforecasting_agent.runtime.gateway.prompt_choice", side_effect=prompt_choice_responses), \
         patch("superforecasting_agent.runtime.gateway.prompt", side_effect=prompt_responses), \
         patch("superforecasting_agent.runtime.gateway.print_info"), \
         patch("superforecasting_agent.runtime.gateway.print_success"), \
         patch("superforecasting_agent.runtime.gateway.print_warning"), \
         patch("superforecasting_agent.runtime.gateway.print_error"), \
         patch("superforecasting_agent.runtime.gateway.color", side_effect=lambda t, c: t), \
         patch("gateway.platforms.feishu.qr_register", return_value=qr_result):

        from superforecasting_agent.runtime.gateway import _setup_feishu
        _setup_feishu()
