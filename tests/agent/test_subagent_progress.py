...
Verifies that:
- ForecastSpinner.print_above() works with and without active spinner
...
class TestBuildChildProgressCallback:
    ...
    def test_cli_spinner_tool_event(self):
        ...
        buf = io.StringIO()
        spinner = ForecastSpinner("delegating")
        spinner._out = buf
