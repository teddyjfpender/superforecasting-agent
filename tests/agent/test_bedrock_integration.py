...
Note: Tests that import ``superforecasting_agent.runtime.auth`` or ``superforecasting_agent.runtime.runtime_provider``
...
class TestProvidersModule:
    """Verify bedrock is wired into superforecasting_agent/runtime/providers.py."""

    def test_bedrock_alias_in_providers(self):
        from superforecasting_agent.runtime.providers import ALIASES
    ...
    def test_bedrock_transport_mapping(self):
        from superforecasting_agent.runtime.providers import TRANSPORT_TO_API_MODE
