...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import forecast_tools_mcp_server as m
    ...
    def test_exposed_tools_are_safe_subset(self):
        ...
        from agent.transports.forecast_tools_mcp_server import EXPOSED_TOOLS
        forbidden = {
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.forecast_tools_mcp_server as m
...
def test_legacy_module_launches_native_server(monkeypatch, exit_code):
    """Persisted -m commands retain the native server's exit status."""
    import runpy
    from agent.transports import forecast_tools_mcp_server
    ...
    monkeypatch.setattr(forecast_tools_mcp_server, "main", fake_main)
