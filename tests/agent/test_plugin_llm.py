...
""",
        ...
        from superforecasting_agent.runtime import config as _config_mod
...
class TestPluginContextIntegration:
    def test_ctx_llm_is_lazy_singleton(self):
        from superforecasting_agent.runtime.plugins import PluginContext, PluginManifest, PluginManager
