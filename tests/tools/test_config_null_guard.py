...
class TestTrajectoryCompressorNullGuard:
    """superforecasting_agent/trajectories/compression.py — _detect_provider() and config loading"""

    def test_null_base_url_does_not_crash(self):
        """base_url=None should not crash _detect_provider()."""
        from superforecasting_agent.trajectories.compression import CompressionConfig, TrajectoryCompressor
    ...
    def test_config_loading_null_base_url_keeps_default(self):
        ...
        from superforecasting_agent.trajectories.compression import CompressionConfig
