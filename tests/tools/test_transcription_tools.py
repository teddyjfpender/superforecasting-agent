...
class TestLoadSttConfig:
    ...
    def test_real_load_returns_dict(self):
        ...
        with patch.dict("sys.modules", {"superforecasting_agent.runtime": None, "superforecasting_agent.runtime.config": None}):
            from tools.transcription_tools import _load_stt_config
...
def mock_xai_http_module():
    ...
    fake_module = MagicMock()
    fake_module.agent_xai_user_agent = MagicMock(return_value="hermes-xai/test")
