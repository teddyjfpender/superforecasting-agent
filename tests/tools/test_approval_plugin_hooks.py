...
class TestCliPathFiresHooks:
    ...
    def test_pre_and_post_fire_with_expected_kwargs(
        ...
        with patch("superforecasting_agent.runtime.plugins.invoke_hook", side_effect=fake_invoke_hook):
    ...
    def test_plugin_hook_crash_does_not_break_approval(
        ...
        with patch("superforecasting_agent.runtime.plugins.invoke_hook", side_effect=boom):
            result = check_all_command_guards(
