    ...
    def test_bare_setup_runs_full_reconfigure_without_menu(self, existing_install):
        ...
        with ExitStack() as stack:
            m = _enter_existing_install_patches(
                stack,
                prompt_choice="superforecasting_agent.runtime.setup.prompt_choice",
                quick="superforecasting_agent.runtime.setup._run_quick_setup",
                model="superforecasting_agent.runtime.setup.setup_model_provider",
                terminal="superforecasting_agent.runtime.setup.setup_terminal_backend",
    ...
    def test_bare_setup_runs_first_time_flow(self, fresh_install):
        ...
        with ExitStack() as stack:
            m = _enter_fresh_install_patches(
                stack,
                prompt=("superforecasting_agent.runtime.setup.prompt_choice", {"return_value": 0}),
                first="superforecasting_agent.runtime.setup._run_first_time_quick_setup",
            )
            from superforecasting_agent.runtime.setup import run_setup_wizard
            run_setup_wizard(args)
...
class TestArgparse:
    ...
    def test_reconfigure_flag_reaches_cmd_setup(self, monkeypatch):
        ...
        captured = {}
        monkeypatch.setattr(
            "superforecasting_agent.runtime.setup.run_setup_wizard",
