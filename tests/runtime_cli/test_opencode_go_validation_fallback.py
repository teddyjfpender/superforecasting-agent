...
from superforecasting_agent.runtime.models import validate_requested_model
...
def _patched(func):
    ...
    def wrapper(*args, **kwargs):
        with patch("superforecasting_agent.runtime.models.fetch_api_models", return_value=None), \
             patch("superforecasting_agent.runtime.models.probe_api_models", return_value=_UNREACHABLE_PROBE):
