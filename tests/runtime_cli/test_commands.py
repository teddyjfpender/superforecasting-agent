...
from superforecasting_agent.runtime.commands import discord_skill_commands_by_category  # noqa: E402
...
class TestPluginCommandEnumeration:
    ...
    def _patch_plugin_commands(self, monkeypatch, commands):
        """Monkeypatch superforecasting_agent.runtime.plugins.get_plugin_commands() to a fixed dict."""
        from superforecasting_agent.runtime import plugins as _plugins_mod
