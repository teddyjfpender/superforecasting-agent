...
from superforecasting_agent.runtime.codex_models import DEFAULT_CODEX_MODELS, get_codex_model_ids
...
def test_setup_wizard_codex_import_resolves():
    ...
    # This mirrors the exact import used in superforecasting_agent/runtime/setup.py line 873.
    # A prior bug had 'get_codex_models' (wrong) instead of 'get_codex_model_ids'.
    from superforecasting_agent.runtime.codex_models import get_codex_model_ids as setup_import
...
def test_get_codex_model_ids_adds_forward_compat_models_from_templates(monkeypatch):
    monkeypatch.setattr(
        "superforecasting_agent.runtime.codex_models._fetch_models_from_api",
...
def test_fetch_from_api_keeps_supported_in_api_false_models(monkeypatch):
    ...
    """
    import sys
    from superforecasting_agent.runtime import codex_models
...
def test_model_command_uses_runtime_access_token_for_codex_list(monkeypatch):
    from superforecasting_agent.runtime.main import _model_flow_openai_codex
...
def test_model_command_prompts_to_reuse_or_reauthenticate_codex_session(monkeypatch, capsys):
    ...
    monkeypatch.setattr("superforecasting_agent.runtime.auth._login_openai_codex", _fake_login)
    monkeypatch.setattr(
        "superforecasting_agent.runtime.codex_models.get_codex_model_ids",
...
def test_model_command_uses_existing_codex_session_without_relogin(monkeypatch):
    ...
    monkeypatch.setattr(
        "superforecasting_agent.runtime.auth._login_openai_codex",
