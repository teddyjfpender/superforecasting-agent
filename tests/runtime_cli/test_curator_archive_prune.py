"""Tests for `superforecasting-agent curator archive` and `superforecasting-agent curator prune`.
...
def test_archive_refuses_pinned(monkeypatch, capsys):
    ...
    assert "superforecasting-agent curator unpin" in out
...
def test_archive_and_prune_registered():
    ...
    parser = argparse.ArgumentParser(prog="superforecasting-agent curator")
