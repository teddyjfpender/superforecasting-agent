"""Tests for superforecasting_agent.runtime.doctor."""
...
import superforecasting_agent.runtime.doctor as doctor
...
from superforecasting_agent.runtime.doctor import _has_provider_env_config
...
class TestGitHubTokenCheck:
    ...
    def test_no_token_and_not_gh_authenticated_shows_warn(self, monkeypatch, tmp_path):
        ...
        from superforecasting_agent.runtime.doctor import run_doctor, _DHH
        import io, contextlib
