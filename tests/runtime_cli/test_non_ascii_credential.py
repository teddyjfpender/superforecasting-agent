...
from superforecasting_agent.runtime.config import _check_non_ascii_credential
...
class TestEnvLoaderSanitization:
    ...
    def test_strips_non_ascii_from_api_key(self, monkeypatch):
        from superforecasting_agent.runtime.env_loader import _sanitize_loaded_credentials, _WARNED_KEYS
    ...
    def test_ignores_non_credential_vars(self, monkeypatch):
        from superforecasting_agent.runtime.env_loader import _sanitize_loaded_credentials
    ...
    def test_warns_to_stderr_when_stripping(self, monkeypatch, capsys):
        ...
        assert "superforecasting-agent setup" in captured.err
