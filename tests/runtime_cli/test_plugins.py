"""Tests for the inherited plugin system (superforecasting_agent.runtime.plugins)."""
...
class TestPluginHooks:
    ...
    def test_invalid_hook_name_warns(self, tmp_path, monkeypatch, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="superforecasting_agent.runtime.plugins"):
            mgr = PluginManager()
            mgr.discover_and_load()
...
class TestPreToolCallBlocking:
    ...
    def test_block_message_returned_for_valid_directive(self, monkeypatch):
        monkeypatch.setattr(
            "superforecasting_agent.runtime.plugins.invoke_hook",
...
class TestPluginCommands:
    ...
    def test_get_plugin_command_handler_found(self):
        ...
        with patch("superforecasting_agent.runtime.plugins._plugin_manager", mgr):
...
class TestPluginCommandResultResolution:
    ...
    def test_awaits_async_result_with_running_loop(self, monkeypatch):
        ...
        monkeypatch.setattr("superforecasting_agent.runtime.plugins.asyncio.get_running_loop", lambda: _Loop())
    ...
    def test_running_loop_timeout_does_not_hang_forever(self, monkeypatch):
        ...
        monkeypatch.setattr("superforecasting_agent.runtime.plugins.asyncio.get_running_loop", lambda: _Loop())
        monkeypatch.setattr("superforecasting_agent.runtime.plugins._PLUGIN_COMMAND_AWAIT_TIMEOUT_SECS", 0.1)
...
class TestPluginDispatchTool:
    ...
    def test_dispatch_tool_calls_registry(self):
        ...
        with patch("superforecasting_agent.runtime.plugins.PluginContext.dispatch_tool.__module__", "superforecasting_agent.runtime.plugins"):
