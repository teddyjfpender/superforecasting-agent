"""Tests for superforecasting_agent.runtime.kanban_diagnostics — rule-engine that produces
...
def test_triage_aux_unavailable_fires_auto_decompose_off_points_at_specifier():
    ...
    assert any("superforecasting-agent kanban specify" in l for l in labels)
