...
from superforecasting_agent.runtime.main, these tests mock the delegation point and verify
that the setup wizard correctly syncs config from disk after the call.
"""

from __future__ import annotations

from superforecasting_agent.runtime.config import load_config, save_config, save_env_value
from superforecasting_agent.runtime.nous_subscription import NousFeatureState, NousSubscriptionFeatures
from superforecasting_agent.runtime.setup import _print_setup_summary, setup_model_provider
...
def test_setup_same_provider_rotation_strategy_saved_for_multi_credential_pool(tmp_path, monkeypatch):
    ...
    import superforecasting_agent.runtime.main as _main_mod
    import superforecasting_agent.runtime.setup as _setup_mod
...
def test_setup_same_provider_fallback_can_add_another_credential(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("superforecasting_agent.runtime.auth_commands.auth_add_command", fake_auth_add_command)
