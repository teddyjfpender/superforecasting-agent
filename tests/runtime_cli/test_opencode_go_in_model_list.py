...
# The curated list in superforecasting_agent/runtime/models.py defines the floor; models.dev only
...
def test_opencode_go_appears_when_api_key_set():
    ...
    # models.dev is reachable) or "hermes" (from PROVIDER_OVERLAYS fallback when
