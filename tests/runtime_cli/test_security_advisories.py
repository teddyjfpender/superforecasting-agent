"""Tests for superforecasting_agent.runtime.security_advisories.
...
import superforecasting_agent.runtime.security_advisories as adv
...
class TestAck:
    ...
    def test_ack_advisory_persists_id(self, isolated_home, monkeypatch):
        ...
        # don't depend on the full superforecasting_agent.runtime.config bootstrap.
        store: dict = {"security": {}}
        monkeypatch.setattr(
            "superforecasting_agent.runtime.config.load_config", lambda: store
        )
        monkeypatch.setattr(
            "superforecasting_agent.runtime.config.save_config",
...
class TestRendering:
    def test_short_banner_lines_includes_id_and_version(self, fake_advisory):
        ...
        assert "superforecasting-agent doctor" in joined
