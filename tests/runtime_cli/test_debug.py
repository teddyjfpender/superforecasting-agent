...
class TestUploadPasteRs:
    ...
    def test_upload_paste_rs_success(self):
        from superforecasting_agent.runtime.debug import _upload_paste_rs
        ...
        with patch("superforecasting_agent.runtime.debug.urllib.request.urlopen", return_value=mock_resp):
    ...
    def test_upload_paste_rs_network_error(self):
        ...
        with patch(
            "superforecasting_agent.runtime.debug.urllib.request.urlopen",
...
class TestUploadDpasteCom:
    ...
    def test_upload_dpaste_com_success(self):
        from superforecasting_agent.runtime.debug import _upload_dpaste_com
...
class TestUploadToPastebin:
    ...
    def test_tries_paste_rs_first(self):
        from superforecasting_agent.runtime.debug import upload_to_pastebin

        with patch("superforecasting_agent.runtime.debug._upload_paste_rs",
    ...
    def test_falls_back_to_dpaste_com(self):
        ...
        with patch("superforecasting_agent.runtime.debug._upload_paste_rs",
             ...
             patch("superforecasting_agent.runtime.debug._upload_dpaste_com",
...
class TestRunDebugShare:
    ...
    def test_share_sweeps_expired_pastes(self, hermes_home, capsys):
        ...
        with patch("superforecasting_agent.runtime.dump.run_dump"), \
             patch("superforecasting_agent.runtime.debug._sweep_expired_pastes", return_value=(0, 0)) as mock_sweep, \
    ...
    def test_share_survives_sweep_failure(self, hermes_home, capsys):
        ...
        with patch("superforecasting_agent.runtime.dump.run_dump"), \
             patch(
                 "superforecasting_agent.runtime.debug._sweep_expired_pastes",
    ...
    def test_share_uploads_three_pastes(self, hermes_home, capsys):
        ...
        assert "--- superforecasting-agent dump ---" in agent_paste
    ...
    def test_share_keeps_report_and_full_log_on_same_snapshot(self, hermes_home, capsys):
        ...
        with patch("superforecasting_agent.runtime.dump.run_dump"), \
             patch("superforecasting_agent.runtime.debug.collect_debug_report", side_effect=_wrapped_collect_debug_report), \
             patch("superforecasting_agent.runtime.debug.upload_to_pastebin", side_effect=_mock_upload):
            run_debug_share(args)
...
class TestRunDebugShareRedaction:
    ...
    def test_default_share_redacts_uploaded_content(
        ...
        with patch("superforecasting_agent.runtime.dump.run_dump"), \
             patch("superforecasting_agent.runtime.debug._sweep_expired_pastes", return_value=(0, 0)), \
             patch("superforecasting_agent.runtime.debug.upload_to_pastebin", side_effect=fake_upload):
            run_debug_share(args)
...
class TestRunDebug:
    def test_no_subcommand_shows_usage(self, capsys):
        ...
        out = capsys.readouterr().out
        assert "superforecasting-agent debug" in out
        assert "share" in out
...
class TestExtractPasteId:
    def test_paste_rs_url(self):
        from superforecasting_agent.runtime.debug import _extract_paste_id
...
class TestDeletePaste:
    def test_delete_sends_delete_request(self):
        from superforecasting_agent.runtime.debug import delete_paste
        ...
        with patch("superforecasting_agent.runtime.debug.urllib.request.urlopen",
...
class TestScheduleAutoDelete:
    ...
    def test_does_not_spawn_subprocess(self, hermes_home):
        ...
        import ast
        import inspect
        from superforecasting_agent.runtime.debug import _schedule_auto_delete
...
class TestSweepExpiredPastes:
    ...
    def test_sweep_deletes_expired_entries(self, hermes_home):
        ...
        with patch("superforecasting_agent.runtime.debug.delete_paste", side_effect=fake_delete):
            deleted, remaining = _sweep_expired_pastes()
    ...
    def test_sweep_leaves_future_entries_alone(self, hermes_home):
        ...
        with patch("superforecasting_agent.runtime.debug.delete_paste") as mock_delete:
            deleted, remaining = _sweep_expired_pastes()
    ...
    def test_sweep_survives_network_failure(self, hermes_home):
        ...
        with patch(
            "superforecasting_agent.runtime.debug.delete_paste",
...
class TestRunDebugSweepsOnInvocation:
    ...
    def test_run_debug_calls_sweep(self, hermes_home):
        ...
        with patch("superforecasting_agent.runtime.debug._sweep_expired_pastes") as mock_sweep:
            run_debug(args)
    ...
    def test_run_debug_survives_sweep_failure(self, hermes_home, capsys):
        ...
        out = capsys.readouterr().out
        assert "Usage: superforecasting-agent debug" in out


class TestRunDebugDelete:
    def test_deletes_valid_url(self, capsys):
        from superforecasting_agent.runtime.debug import run_debug_delete

        args = MagicMock()
        args.urls = ["https://paste.rs/abc"]

        with patch("superforecasting_agent.runtime.debug.delete_paste", return_value=True):
    ...
    def test_handles_delete_failure(self, capsys):
        ...
        with patch("superforecasting_agent.runtime.debug.delete_paste",
...
class TestShareIncludesAutoDelete:
    ...
    def test_share_schedules_auto_delete(self, hermes_home, capsys):
        ...
        with patch("superforecasting_agent.runtime.dump.run_dump"), \
             ...
             patch("superforecasting_agent.runtime.debug._schedule_auto_delete") as mock_sched:
            run_debug_share(args)
