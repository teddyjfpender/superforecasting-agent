...
PROVIDER_OVERLAYS keys may be models.dev IDs (e.g. "github-copilot") while
...
def test_provider_overlay_compatibility_imports():
    from superforecasting_agent.runtime import providers
    from superforecasting_agent.runtime.provider_catalog import ProviderOverlay, PROVIDER_OVERLAYS

    assert providers.ProviderOverlay is providers.HermesOverlay is ProviderOverlay
    assert providers.PROVIDER_OVERLAYS is providers.HERMES_OVERLAYS is PROVIDER_OVERLAYS
