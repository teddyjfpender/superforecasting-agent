...
class TestMigrate:
    ...
    def test_plugin_discovery_writes_plugin_blocks(self, tmp_path, monkeypatch):
        ...
        from superforecasting_agent.runtime import codex_runtime_plugin_migration as crpm
    ...
    def test_plugin_discovery_skips_unavailable_plugins(self):
        ...
        from superforecasting_agent.runtime.codex_runtime_plugin_migration import _query_codex_plugins
    ...
    def test_expose_hermes_tools_writes_callback_mcp_entry(self, tmp_path):
        ...
        assert "forecast_tools_mcp_server" in text
    ...
    def test_expose_hermes_tools_disabled_skips_entry(self, tmp_path):
        ...
        assert "forecast_tools_mcp_server" not in text
...
class TestStripUnmanagedPluginTables:
    ...
    def test_migrate_dedups_codex_owned_plugin_tables(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "superforecasting_agent.runtime.codex_runtime_plugin_migration._query_codex_plugins",
            fake_query,
        )
