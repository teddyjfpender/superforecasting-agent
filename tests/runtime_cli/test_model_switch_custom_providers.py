...
import superforecasting_agent.runtime.providers as providers_mod
...
def test_list_authenticated_providers_includes_custom_providers(monkeypatch):
    ...
    monkeypatch.setattr(providers_mod, "PROVIDER_OVERLAYS", {})
...
def test_switch_model_accepts_explicit_named_custom_provider(monkeypatch):
    ...
    monkeypatch.setattr("superforecasting_agent.runtime.models.validate_requested_model", lambda *a, **k: _MOCK_VALIDATION)
    monkeypatch.setattr("superforecasting_agent.runtime.model_switch.get_model_info", lambda *a, **k: None)
    monkeypatch.setattr("superforecasting_agent.runtime.model_switch.get_model_capabilities", lambda *a, **k: None)
...
def test_switch_model_unknown_provider_uses_fork_native_guidance(monkeypatch):
    ...
    monkeypatch.setattr("superforecasting_agent.runtime.config.validate_config_structure", lambda: [])
...
def test_lmstudio_picker_probes_active_config_base_url(monkeypatch):
    ...
    monkeypatch.setattr("superforecasting_agent.runtime.models.fetch_lmstudio_models", _fake_fetch)
