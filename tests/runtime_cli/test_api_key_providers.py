...
from superforecasting_agent.runtime.copilot_auth import _try_gh_cli_token
...
class TestResolveApiKeyProviderCredentials:
    ...
    def test_try_gh_cli_token_uses_homebrew_path_when_not_on_path(self, monkeypatch):
        monkeypatch.setattr("superforecasting_agent.runtime.copilot_auth.shutil.which", lambda command: None)
        monkeypatch.setattr(
            "superforecasting_agent.runtime.copilot_auth.os.path.isfile",
            lambda path: path == "/opt/homebrew/bin/gh",
        )
        monkeypatch.setattr(
            "superforecasting_agent.runtime.copilot_auth.os.access",
        ...
        monkeypatch.setattr("superforecasting_agent.runtime.copilot_auth.subprocess.run", _fake_run)
...
class TestKimiMoonshotModelListIsolation:
    ...
    def test_moonshot_list_excludes_coding_plan_only_models(self):
        from superforecasting_agent.runtime.main import _PROVIDER_MODELS
...
class TestHuggingFaceModels:
    ...
    def test_model_lists_match(self):
        ...
        from superforecasting_agent.runtime.main import _PROVIDER_MODELS as main_models
        from superforecasting_agent.runtime.models import _PROVIDER_MODELS as models_models
    ...
    def test_provider_aliases_in_models_py(self):
        from superforecasting_agent.runtime.models import _PROVIDER_ALIASES
...
class TestNovitaProvider:
    ...
    def test_novita_pricing_cache(self, monkeypatch):
        ...
        from superforecasting_agent.runtime import models as models_mod
