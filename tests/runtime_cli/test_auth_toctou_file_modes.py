"""Regression tests for TOCTOU-safe credential file writers in ``superforecasting_agent.runtime.auth``.
...
def test_shared_nous_store_writes_0o600_with_0o700_parent(tmp_path, monkeypatch):
    ...
    # get_default_agent_root() — can't collide with our override and
