...
class TestShouldExclude:
    def test_excludes_hermes_agent(self):
        from superforecasting_agent.runtime.backup import _should_exclude
...
class TestBackup:
    def test_creates_zip(self, tmp_path, monkeypatch):
        ...
        # get_default_agent_root needs this
...
class TestValidateBackupZip:
    ...
    def test_state_db_passes(self, tmp_path):
        ...
        from superforecasting_agent.runtime.backup import _validate_backup_zip
...
class TestRoundTrip:
    def test_backup_then_import(self, tmp_path, monkeypatch):
        ...
        from superforecasting_agent.runtime.backup import run_backup, run_import
...
class TestFormatSize:
    def test_bytes(self):
        from superforecasting_agent.runtime.backup import _format_size
...
class TestValidation:
    ...
    def test_detect_prefix_hermes(self):
        ...
        import io
        from superforecasting_agent.runtime.backup import _detect_prefix
...
class TestProfileRestoration:
    ...
    def test_import_without_profiles_module(self, tmp_path, monkeypatch):
        ...
        import superforecasting_agent.runtime.backup as backup_mod
...
class TestQuickSnapshot:
    ...
    def test_list_snapshots(self, hermes_home):
        from superforecasting_agent.runtime.backup import create_quick_snapshot, list_quick_snapshots
    ...
    def test_restore_config(self, hermes_home):
        from superforecasting_agent.runtime.backup import create_quick_snapshot, restore_quick_snapshot
        snap_id = create_quick_snapshot(hermes_home=hermes_home)
    ...
    def test_restore_nonexistent(self, hermes_home):
        from superforecasting_agent.runtime.backup import restore_quick_snapshot
        assert restore_quick_snapshot("nonexistent", hermes_home=hermes_home) is False

    def test_auto_prune(self, hermes_home):
        from superforecasting_agent.runtime.backup import create_quick_snapshot, list_quick_snapshots, _QUICK_DEFAULT_KEEP
    ...
    def test_manual_prune(self, hermes_home):
        from superforecasting_agent.runtime.backup import create_quick_snapshot, prune_quick_snapshots, list_quick_snapshots
        for i in range(10):
            create_quick_snapshot(label=f"s{i}", hermes_home=hermes_home)
...
class TestRunPreUpdateBackup:
    ...
    def test_backup_flag_creates_backup(self, hermes_home, capsys):
        ...
        from superforecasting_agent.runtime.main import _run_pre_update_backup
...
class TestPreMigrationBackup:
    ...
    def test_creates_backup_under_backups_dir(self, hermes_home):
        from superforecasting_agent.runtime.backup import create_pre_migration_backup
    ...
    def test_restorable_with_superforecasting_agent_import(self, hermes_home, tmp_path):
        ...
        from superforecasting_agent.runtime.backup import create_pre_migration_backup, _validate_backup_zip
        out = create_pre_migration_backup(hermes_home=hermes_home)
        assert out is not None
        with zipfile.ZipFile(out) as zf:
    ...
    def test_does_not_touch_pre_update_backups(self, hermes_home):
        ...
        from superforecasting_agent.runtime.backup import create_pre_update_backup, create_pre_migration_backup
