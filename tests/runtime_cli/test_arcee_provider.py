...
class TestArceeURLMapping:
    ...
    def test_trajectory_compression_detects_arcee(self):
        import superforecasting_agent.trajectories.compression as tc
...
class TestArceeProvidersModule:
    def test_overlay_exists(self):
        ...
        assert "arcee" in PROVIDER_OVERLAYS
        overlay = PROVIDER_OVERLAYS["arcee"]
