"""Tests for superforecasting_agent.runtime.model_catalog — remote manifest fetch + cache + fallback."""
...
def isolated_home(tmp_path, monkeypatch):
    ...
    import importlib
    from superforecasting_agent.runtime import model_catalog
...
class TestValidation:
    def test_accepts_well_formed_manifest(self, isolated_home):
        from superforecasting_agent.runtime.model_catalog import _validate_manifest
...
class TestIntegrationWithModelsModule:
    """Exercise the fallback paths via the real callers in superforecasting_agent.runtime.models."""

    def test_curated_nous_ids_falls_back_to_hardcoded_on_empty_catalog(
        self, isolated_home
    ):
        from superforecasting_agent.runtime import model_catalog
        from superforecasting_agent.runtime.models import get_curated_nous_model_ids, _PROVIDER_MODELS
    ...
    def test_curated_nous_ids_prefers_manifest(self, isolated_home):
        from superforecasting_agent.runtime import model_catalog
        from superforecasting_agent.runtime.models import get_curated_nous_model_ids
    ...
    def test_picker_nous_row_uses_manifest(self, tmp_path, monkeypatch):
        ...
        importlib.reload(model_catalog)
        try:
            from superforecasting_agent.runtime.model_switch import list_picker_providers
