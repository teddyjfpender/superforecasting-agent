"""Tests for superforecasting_agent.runtime.copilot_auth — Copilot token validation and resolution."""
...
class TestTokenValidation:
    ...
    def test_classic_pat_rejected(self):
        ...
        assert "ghp_" in msg
        assert "superforecasting-agent model" in msg
...
class TestRequestHeaders:
    ...
    def test_default_headers_include_openai_intent(self):
        ...
        assert headers["User-Agent"] == "SuperforecastingAgent/1.0"
