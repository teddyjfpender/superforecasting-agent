...
from superforecasting_agent.runtime.config import load_env, save_env_value
...
class TestStaleOAuthTokenDetection:
    ...
    def test_stale_oauth_token_triggers_reauth(self, tmp_path, monkeypatch, capsys):
        ...
        monkeypatch.setattr("superforecasting_agent.runtime.secret_prompt.masked_secret_prompt", lambda _: "")

        from superforecasting_agent.runtime.main import _model_flow_anthropic
        cfg = {}
