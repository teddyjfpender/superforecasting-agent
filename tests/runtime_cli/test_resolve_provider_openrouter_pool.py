"""Regression tests for upstream issue #42130.

A credential added via `auth add openrouter` lives in the credential
...
def _seed_openrouter_pool(token: str = "sk-or-FAKEKEY123") -> None:
    """Mimic `auth add openrouter <token>` — a manual pool entry."""
