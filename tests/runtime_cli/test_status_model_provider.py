"""Tests for superforecasting_agent.runtime.status model/provider display."""
...
def test_show_status_displays_configured_dict_model_and_provider_label(monkeypatch, capsys, tmp_path):
    from superforecasting_agent.runtime import status as status_mod
...
def test_show_status_reports_managed_nous_features(monkeypatch, capsys, tmp_path):
    monkeypatch.setattr("superforecasting_agent.runtime.status.managed_nous_tools_enabled", lambda: True)
    from superforecasting_agent.runtime import status as status_mod
...
def test_show_status_hides_nous_subscription_section_when_feature_flag_is_off(monkeypatch, capsys, tmp_path):
    monkeypatch.setattr("superforecasting_agent.runtime.status.managed_nous_tools_enabled", lambda: False)
    from superforecasting_agent.runtime import status as status_mod
...
def test_show_status_reports_empty_lmstudio_listing_as_reachable(monkeypatch, capsys, tmp_path):
    ...
    monkeypatch.setattr(
        "superforecasting_agent.runtime.models.probe_lmstudio_models",
