...
class TestToolsDisableBuiltin:
    ...
    def test_disable_removes_toolset_from_platform(self):
        ...
        with patch("superforecasting_agent.runtime.tools_config.load_config", return_value=config), \
             patch("superforecasting_agent.runtime.tools_config.save_config") as mock_save:
