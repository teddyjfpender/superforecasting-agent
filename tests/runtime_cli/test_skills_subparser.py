...
def test_no_duplicate_skills_subparser(monkeypatch):
    ...
    import superforecasting_agent.runtime as runtime

    # Fresh import without leaking a replacement module to later tests.
    monkeypatch.delitem(sys.modules, "superforecasting_agent.runtime.main", raising=False)
    monkeypatch.delattr(runtime, "main", raising=False)

    try:
        import superforecasting_agent.runtime.main  # noqa: F401
