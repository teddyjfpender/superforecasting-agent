"""Tests for the kanban CLI surface (superforecasting_agent.runtime.kanban)."""
...
from superforecasting_agent.runtime import kanban as kc
...
def test_kanban_in_autocomplete_table():
    from superforecasting_agent.runtime.commands import COMMANDS, SUBCOMMANDS
...
def test_kanban_not_gateway_only():
    ...
    from superforecasting_agent.runtime.commands import COMMAND_REGISTRY
