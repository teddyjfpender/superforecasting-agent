...
def test_service_path_skips_nonexistent_node_modules(tmp_path):
    ...
    from superforecasting_agent.runtime.gateway import _build_service_path_dirs
    with patch("superforecasting_agent.runtime.gateway.get_agent_home", return_value=tmp_path / ".hermes"):
