"""Tests for get_agent_home() profile-mode fallback warning.
...
profile is active, get_agent_home() should:
...
def fresh_constants(monkeypatch, tmp_path):
    """Import superforecasting_agent.constants fresh and reset the one-shot warn flag."""
    import importlib
    ...
    return superforecasting_agent.constants
...
class TestGetHermesHomeProfileWarning:
    def test_classic_mode_no_active_profile_no_warning(
        ...
        result = fresh_constants.get_agent_home()
    ...
    def test_named_profile_unset_home_warns_once(
        ...
        fresh_constants.get_agent_home()
        fresh_constants.get_agent_home()
