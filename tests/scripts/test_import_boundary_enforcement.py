...
@pytest.mark.parametrize("source", ["protocol", "superforecasting_agent.application", "forecasting.distribution_summary", "superforecasting_agent.constants", "superforecasting_agent.profile_paths", "forecasting.application", "superforecasting_agent.session_context", "superforecasting_agent.platform_registry", "superforecasting_agent.hosting.workers", "superforecasting_agent.hosting.sessions", "superforecasting_agent.hosting.storage", "superforecasting_agent.hosting.configuration"])
