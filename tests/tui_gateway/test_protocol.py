...
def test_disable_flush_env_var_actually_wires_to_module_constant(monkeypatch):
    """End-to-end: setting a fork-native no-flush env var and importing
    ...
    monkeypatch.setenv("SUPERFORECASTING_AGENT_TUI_GATEWAY_NO_FLUSH", "1")
    ...
    try:
        ...
        monkeypatch.delenv("SUPERFORECASTING_AGENT_TUI_GATEWAY_NO_FLUSH", raising=False)
        monkeypatch.delenv("FORECAST_TUI_GATEWAY_NO_FLUSH", raising=False)
