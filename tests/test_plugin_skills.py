...
- superforecasting_agent/runtime/plugins register_skill API + registry
...
class TestSkillViewPluginGuards:
    ...
    def test_disabled_plugin(self, tmp_path, monkeypatch):
        ...
        self._reg(tmp_path, "---\nname: foo\n---\nBody.\n")
        monkeypatch.setattr("superforecasting_agent.runtime.plugins._get_disabled_plugins", lambda: {"myplugin"})
