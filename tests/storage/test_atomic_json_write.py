"""Tests for superforecasting_agent.storage.files.atomic_json_write — crash-safe JSON file writes."""
...
class TestAtomicJsonWrite:
    ...
    def test_cleans_up_temp_file_on_baseexception(self, tmp_path):
        ...
        with patch("superforecasting_agent.storage.files.json.dump", side_effect=SimulatedAbort):
