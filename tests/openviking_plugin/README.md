...
Exercises openviking plugin behavior and regressions using the canonical Python test environment. Read the test names and fixtures below to locate the contract closest to a change.
...
| File                                     | Responsibility                                                                            |
| ---------------------------------------- | ----------------------------------------------------------------------------------------- |
| [test_openviking.py](test_openviking.py) | Tests for plugins/memory/openviking/**init**.py — URI normalization and payload handling. |
