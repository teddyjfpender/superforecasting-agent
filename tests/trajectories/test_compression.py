"""Tests for superforecasting_agent/trajectories/compression.py — config, metrics, and compression logic."""
...
from superforecasting_agent.trajectories.compression import (
    CompressionConfig,
    TrajectoryMetrics,
    AggregateMetrics,
...
def test_import_loads_env_from_hermes_home(tmp_path, monkeypatch):
    ...
    sys.modules.pop("superforecasting_agent.trajectories.compression", None)
    importlib.import_module("superforecasting_agent.trajectories.compression")
