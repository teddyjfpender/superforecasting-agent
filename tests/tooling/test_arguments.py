...
from superforecasting_agent.tooling.arguments import (
    coerce_tool_args,
    _coerce_value,
    _coerce_number,
    _coerce_boolean,
...
class TestCoerceToolArgs:
    ...
    def test_coerces_integer_arg(self):
        ...
        with patch("superforecasting_agent.tooling.arguments.registry.get_schema", return_value=schema):
            args = {"limit": "10"}
    ...
    def test_unknown_tool_returns_args_unchanged(self):
        with patch("superforecasting_agent.tooling.arguments.registry.get_schema", return_value=None):
            args = {"limit": "10"}
