...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("superforecasting_agent.runtime.config.get_config_path", return_value=config_path), \
             patch("superforecasting_agent.runtime.config.ensure_hermes_home"):
    ...
    def test_ensure_hermes_home_sets_0700(self):
        ...
        with patch("superforecasting_agent.runtime.config.get_agent_home", return_value=home):
