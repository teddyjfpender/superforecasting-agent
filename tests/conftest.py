...
_HERMES_BEHAVIORAL_VARS = frozenset({
    ...
    "FORECAST_EXEC_ASK",
    "HERMES_EXEC_ASK",
    "SUPERFORECASTING_AGENT_SESSION_PLATFORM",
    "FORECAST_SESSION_PLATFORM",
    "HERMES_SESSION_PLATFORM",
    "SUPERFORECASTING_AGENT_SESSION_CHAT_ID",
    "FORECAST_SESSION_CHAT_ID",
    "HERMES_SESSION_CHAT_ID",
    "SUPERFORECASTING_AGENT_SESSION_CHAT_NAME",
    "FORECAST_SESSION_CHAT_NAME",
    "HERMES_SESSION_CHAT_NAME",
    "SUPERFORECASTING_AGENT_SESSION_THREAD_ID",
    "FORECAST_SESSION_THREAD_ID",
    "HERMES_SESSION_THREAD_ID",
    "SUPERFORECASTING_AGENT_SESSION_USER_ID",
    "FORECAST_SESSION_USER_ID",
    "HERMES_SESSION_USER_ID",
    "SUPERFORECASTING_AGENT_SESSION_USER_NAME",
    "FORECAST_SESSION_USER_NAME",
    "HERMES_SESSION_USER_NAME",
    "SUPERFORECASTING_AGENT_SESSION_SOURCE",
    "FORECAST_SESSION_SOURCE",
    "HERMES_SESSION_SOURCE",
    "SUPERFORECASTING_AGENT_SESSION_KEY",
    "FORECAST_SESSION_KEY",
    "HERMES_SESSION_KEY",
    "SUPERFORECASTING_AGENT_SESSION_ID",
    "FORECAST_SESSION_ID",
    "HERMES_SESSION_ID",
    "SUPERFORECASTING_AGENT_SESSION_MESSAGE_ID",
    "FORECAST_SESSION_MESSAGE_ID",
