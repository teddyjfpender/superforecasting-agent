...
Exercises fixtures behavior and regressions using the canonical Python test environment. Read the test names and fixtures below to locate the contract closest to a change.
...
- [runtime/](runtime/README.md) — runtime.
...
scripts/run_tests.sh tests/fixtures/
```
