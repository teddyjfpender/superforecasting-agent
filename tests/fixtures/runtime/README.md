...
Exercises fixtures/runtime behavior and regressions using the canonical Python test environment. Read the test names and fixtures below to locate the contract closest to a change.
...
| File                                           | Responsibility                                                            |
| ---------------------------------------------- | ------------------------------------------------------------------------- |
| [local_desk_gateway.py](local_desk_gateway.py) | Test-only provider seam; all gateway, transport and journal code is real. |
