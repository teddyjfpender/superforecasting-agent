...
// downside is the portfolio aggregate of its constituents' return distributions
// (see forecasting/factor.py + the dashboard `_workspace_factor`).
...
export interface ForecastFactorHistoryPoint {
  as_of?: string
  created_at?: string
  headline_probability?: null | number // the factor return series (= mean)
